...
const (
	...
	LiveUserRpcService_DtmDemo_FullMethodName               = "/user.v1.LiveUserRpcService/DtmDemo"
	LiveUserRpcService_DtmDemoRollback_FullMethodName       = "/user.v1.LiveUserRpcService/DtmDemoRollback"
)
...
func (c *liveUserRpcServiceClient) DtmDemo(ctx context.Context, in *DtmDemoReq, opts ...grpc.CallOption) (*DtmDemoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DtmDemoResp)
	err := c.cc.Invoke(ctx, LiveUserRpcService_DtmDemo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveUserRpcServiceClient) DtmDemoRollback(ctx context.Context, in *DtmDemoReq, opts ...grpc.CallOption) (*DtmDemoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DtmDemoResp)
	err := c.cc.Invoke(ctx, LiveUserRpcService_DtmDemoRollback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLiveUserRpcServiceServer) DtmDemo(context.Context, *DtmDemoReq) (*DtmDemoResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DtmDemo not implemented")
}
func (UnimplementedLiveUserRpcServiceServer) DtmDemoRollback(context.Context, *DtmDemoReq) (*DtmDemoResp, error) {
...
func _LiveUserRpcService_DtmDemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DtmDemoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveUserRpcServiceServer).DtmDemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveUserRpcService_DtmDemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveUserRpcServiceServer).DtmDemo(ctx, req.(*DtmDemoReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveUserRpcService_DtmDemoRollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DtmDemoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveUserRpcServiceServer).DtmDemoRollback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveUserRpcService_DtmDemoRollback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveUserRpcServiceServer).DtmDemoRollback(ctx, req.(*DtmDemoReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveUserRpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DtmDemo",
			Handler:    _LiveUserRpcService_DtmDemo_Handler,
		},
		{
			MethodName: "DtmDemoRollback",
			Handler:    _LiveUserRpcService_DtmDemoRollback_Handler,
		},
	},
