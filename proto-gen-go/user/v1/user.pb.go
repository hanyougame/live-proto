...
type GetUserBalanceReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`             // 用户ID
	WalletType    int64                  `protobuf:"varint,2,opt,name=wallet_type,json=walletType,proto3" json:"wallet_type,omitempty"` // 钱包类型 todo 待定
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetUserBalanceReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WalletType    int64                  `protobuf:"varint,1,opt,name=wallet_type,json=walletType,proto3" json:"wallet_type,omitempty"` // 钱包类型 todo 待定
...
type UserWalletInfo struct {
	...
	UserId         int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                         // 用户ID
	Balance        int64                  `protobuf:"varint,2,opt,name=balance,proto3" json:"balance,omitempty"`                                     //用户余额
	LockBalance    int64                  `protobuf:"varint,3,opt,name=lock_balance,json=lockBalance,proto3" json:"lock_balance,omitempty"`          //锁定余额
	...
	GoldBalance    int64                  `protobuf:"varint,7,opt,name=gold_balance,json=goldBalance,proto3" json:"gold_balance,omitempty"`          //金币余额
...
func (x *UserWalletInfo) GetLockBalance() int64 {
	if x != nil {
...
func (x *UserWalletInfo) GetGoldBalance() int64 {
	if x != nil {
...
type UpdateUserBalanceReq struct {
	...
	ParentAgentUsername string                 `protobuf:"bytes,4,opt,name=parent_agent_username,json=parentAgentUsername,proto3" json:"parent_agent_username,omitempty"` // 上级代理用户账号
	RegisterSource      string                 `protobuf:"bytes,5,opt,name=register_source,json=registerSource,proto3" json:"register_source,omitempty"`                  // 用户注册来源
	WalletType          int64                  `protobuf:"varint,6,opt,name=wallet_type,json=walletType,proto3" json:"wallet_type,omitempty"`                             // 钱包类型 todo 待定
	Category            int64                  `protobuf:"varint,7,opt,name=category,proto3" json:"category,omitempty"`                                                   // 账变大类
	SubCategory         int64                  `protobuf:"varint,8,opt,name=sub_category,json=subCategory,proto3" json:"sub_category,omitempty"`                          // 账变小类
	FrontendRemark      string                 `protobuf:"bytes,9,opt,name=frontend_remark,json=frontendRemark,proto3" json:"frontend_remark,omitempty"`                  // 前台备注
	BackendRemark       string                 `protobuf:"bytes,10,opt,name=backend_remark,json=backendRemark,proto3" json:"backend_remark,omitempty"`                    // 后台备注
	Operator            string                 `protobuf:"bytes,11,opt,name=operator,proto3" json:"operator,omitempty"`                                                   // 操作人
	TradeTime           int64                  `protobuf:"varint,12,opt,name=trade_time,json=tradeTime,proto3" json:"trade_time,omitempty"`                               // 交易时间
	Username            string                 `protobuf:"bytes,13,opt,name=username,proto3" json:"username,omitempty"`                                                   // 用户账号
	CurrencyCode        string                 `protobuf:"bytes,14,opt,name=currency_code,json=currencyCode,proto3" json:"currency_code,omitempty"`                       // 币种code
	RelatedId           int64                  `protobuf:"varint,15,opt,name=related_id,json=relatedId,proto3" json:"related_id,omitempty"`                               // 关联的id 如游戏id等
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *UpdateUserBalanceReq) GetParentAgentUsername() string {
	if x != nil {
		return x.ParentAgentUsername
	}
	return ""
}

func (x *UpdateUserBalanceReq) GetRegisterSource() string {
	if x != nil {
...
func (x *UpdateUserBalanceReq) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UpdateUserBalanceReq) GetCurrencyCode() string {
	if x != nil {
		return x.CurrencyCode
	}
	return ""
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x4d, 0x0a, 0x11, 0x47, 0x65,
	0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x61, 0x6c, 0x6c,
	0x65, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x77,
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x50, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	0x28, 0x03, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xa1, 0x02, 0x0a, 0x0e,
	0x55, 0x73, 0x65, 0x72, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17,
	...
	0x65, 0x12, 0x21, 0x0a, 0x0c, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x63, 0x75, 0x72, 0x72, 0x65,
	...
	0x62, 0x6f, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x67, 0x6f, 0x6c, 0x64, 0x5f, 0x62, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x67, 0x6f, 0x6c, 0x64, 0x42,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x63, 0x79, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22,
	0x8a, 0x04, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x42, 0x61,
	...
	0x65, 0x72, 0x4e, 0x6f, 0x12, 0x32, 0x0a, 0x15, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x13, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x41, 0x67, 0x65, 0x6e, 0x74,
	0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	,
	...
	0x0a, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x09, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x49, 0x64, 0x22, 0x6a, 0x0a, 0x15,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2d, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0xd8, 0x02, 0x0a, 0x12, 0x4c, 0x69, 0x76, 0x65,
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*UpdateUserBalanceReq)(nil),  // 5: user.v1.UpdateUserBalanceReq
	(*UpdateUserBalanceResp)(nil), // 6: user.v1.UpdateUserBalanceResp
	(*GetUserInfoByIdReq)(nil),    // 7: user.v1.GetUserInfoByIdReq
}
var file_user_v1_user_proto_depIdxs = []int32{
	...
	5, // 2: user.v1.LiveUserRpcService.UpdateUserBalance:input_type -> user.v1.UpdateUserBalanceReq
	7, // 3: user.v1.LiveUserRpcService.GetUserInfoById:input_type -> user.v1.GetUserInfoByIdReq
	1, // 4: user.v1.LiveUserRpcService.GetInfoByUserToken:output_type -> user.v1.UserDetailsInfoReply
	3, // 5: user.v1.LiveUserRpcService.GetUserBalance:output_type -> user.v1.GetUserBalanceReply
	6, // 6: user.v1.LiveUserRpcService.UpdateUserBalance:output_type -> user.v1.UpdateUserBalanceResp
	1, // 7: user.v1.LiveUserRpcService.GetUserInfoById:output_type -> user.v1.UserDetailsInfoReply
