...
type GetUserFullInfoByIdReply struct {
	...
	ChannelId     int64                  `protobuf:"varint,15,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`               // 用户渠道ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetUserFullInfoByIdReply) GetChannelId() int64 {
	if x != nil {
		return x.ChannelId
	}
	return 0
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2!.user.v1.GetUserFullInfoByIdReplyR\x05value:\x028\x01\"\xe6\x03\n" +
	...
	"walletInfo\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x0f \x01(\x03R\tchannelId\"K\n" +
	...
	"\busername\x18\x01 \x01(\tR\busername2\xb9\x06\n" +
	...
	"\x15BatchGetUserBalanceV2\x12!.user.v1.BatchGetUserBalanceV2Req\x1a\".user.v1.BatchGetUserBalanceV2Resp\x124\n" +
	"\aDtmDemo\x12\x13.user.v1.DtmDemoReq\x1a\x14.user.v1.DtmDemoResp\x12<\n" +
	"\x0fDtmDemoRollback\x12\x13.user.v1.DtmDemoReq\x1a\x14.user.v1.DtmDemoRespB\tZ\a./pb/v1b\x06proto3"
...
var file_user_v1_user_proto_goTypes = []any{
	...
	(*DtmDemoReq)(nil),                // 17: user.v1.DtmDemoReq
	(*DtmDemoResp)(nil),               // 18: user.v1.DtmDemoResp
	nil,                               // 19: user.v1.GetUserFullMapInfoReply.UserInfoEntry
	nil,                               // 20: user.v1.BatchGetUserBalanceResp.WalletInfoEntry
	nil,                               // 21: user.v1.BatchGetUserBalanceV2Resp.UserWalletInfoEntry
	nil,                               // 22: user.v1.UserWalletList.WalletInfoEntry
}
var file_user_v1_user_proto_depIdxs = []int32{
	19, // 0: user.v1.GetUserFullMapInfoReply.user_info:type_name -> user.v1.GetUserFullMapInfoReply.UserInfoEntry
	11, // 1: user.v1.GetUserFullInfoByIdReply.wallet_info:type_name -> user.v1.UserWalletInfo
	20, // 2: user.v1.BatchGetUserBalanceResp.wallet_info:type_name -> user.v1.BatchGetUserBalanceResp.WalletInfoEntry
	21, // 3: user.v1.BatchGetUserBalanceV2Resp.user_wallet_info:type_name -> user.v1.BatchGetUserBalanceV2Resp.UserWalletInfoEntry
	22, // 4: user.v1.UserWalletList.wallet_info:type_name -> user.v1.UserWalletList.WalletInfoEntry
	...
	17, // 15: user.v1.LiveUserRpcService.DtmDemo:input_type -> user.v1.DtmDemoReq
	17, // 16: user.v1.LiveUserRpcService.DtmDemoRollback:input_type -> user.v1.DtmDemoReq
	1,  // 17: user.v1.LiveUserRpcService.GetInfoByUserToken:output_type -> user.v1.UserDetailsInfoReply
	3,  // 18: user.v1.LiveUserRpcService.GetUserBalance:output_type -> user.v1.GetUserBalanceReply
	5,  // 19: user.v1.LiveUserRpcService.UpdateUserBalance:output_type -> user.v1.UpdateUserBalanceResp
	1,  // 20: user.v1.LiveUserRpcService.GetUserInfoById:output_type -> user.v1.UserDetailsInfoReply
	10, // 21: user.v1.LiveUserRpcService.GetUserFullInfoById:output_type -> user.v1.GetUserFullInfoByIdReply
	9,  // 22: user.v1.LiveUserRpcService.GetUserFullMapInfo:output_type -> user.v1.GetUserFullMapInfoReply
	13, // 23: user.v1.LiveUserRpcService.BatchGetUserBalance:output_type -> user.v1.BatchGetUserBalanceResp
	15, // 24: user.v1.LiveUserRpcService.BatchGetUserBalanceV2:output_type -> user.v1.BatchGetUserBalanceV2Resp
	18, // 25: user.v1.LiveUserRpcService.DtmDemo:output_type -> user.v1.DtmDemoResp
	18, // 26: user.v1.LiveUserRpcService.DtmDemoRollback:output_type -> user.v1.DtmDemoResp
