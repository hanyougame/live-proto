...
func (m *defaultLiveUserRpcService) DtmDemo(ctx context.Context, in *DtmDemoReq, opts ...grpc.CallOption) (*DtmDemoResp, error) {
	client := v1.NewLiveUserRpcServiceClient(m.cli.Conn())
	return client.DtmDemo(ctx, in, opts...)
}

func (m *defaultLiveUserRpcService) DtmDemoRollback(ctx context.Context, in *DtmDemoReq, opts ...grpc.CallOption) (*DtmDemoResp, error) {
	client := v1.NewLiveUserRpcServiceClient(m.cli.Conn())
