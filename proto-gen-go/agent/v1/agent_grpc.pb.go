...
func (c *liveAgentRpcServiceClient) AgentSettleTaskExecute(ctx context.Context, in *AgentSettleTaskExecuteReq, opts ...grpc.CallOption) (*AgentSettleTaskExecuteResp, error) {
	...
	err := c.cc.Invoke(ctx, LiveAgentRpcService_AgentSettleTaskExecute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveAgentRpcServiceClient) AgentDataCountTaskExecute(ctx context.Context, in *AgentDataCountTaskExecuteReq, opts ...grpc.CallOption) (*AgentDataCountTaskExecuteResp, error) {
	...
	err := c.cc.Invoke(ctx, LiveAgentRpcService_AgentDataCountTaskExecute_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLiveAgentRpcServiceServer must be embedded to have forward compatible implementations.
