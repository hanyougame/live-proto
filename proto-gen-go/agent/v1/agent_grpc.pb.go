...
const (
	...
	LiveAgentRpcService_AgentSettleCount_FullMethodName          = "/agent.v1.LiveAgentRpcService/AgentSettleCount"
)
...
func (c *liveAgentRpcServiceClient) AgentSettleCount(ctx context.Context, in *AgentSettleCountReq, opts ...grpc.CallOption) (*AgentSettleCountResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgentSettleCountResp)
	err := c.cc.Invoke(ctx, LiveAgentRpcService_AgentSettleCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LiveAgentRpcServiceServer interface {
	...
	// 代理结算统计
	AgentSettleCount(context.Context, *AgentSettleCountReq) (*AgentSettleCountResp, error)
...
func (UnimplementedLiveAgentRpcServiceServer) AgentSettleCount(context.Context, *AgentSettleCountReq) (*AgentSettleCountResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AgentSettleCount not implemented")
}
...
func _LiveAgentRpcService_AgentSettleCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AgentSettleCountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveAgentRpcServiceServer).AgentSettleCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveAgentRpcService_AgentSettleCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveAgentRpcServiceServer).AgentSettleCount(ctx, req.(*AgentSettleCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveAgentRpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AgentSettleCount",
			Handler:    _LiveAgentRpcService_AgentSettleCount_Handler,
		},
	},
