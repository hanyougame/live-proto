...
func (UnimplementedLiveGameExternalServiceServer) K9GameResourceListSync(context.Context, *GameReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method K9GameResourceListSync not implemented")
}
func (UnimplementedLiveGameExternalServiceServer) K9GameTransferBetRecordListSync(context.Context, *GameReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method K9GameTransferBetRecordListSync not implemented")
}
...
func RegisterLiveGameExternalServiceServer(s grpc.ServiceRegistrar, srv LiveGameExternalServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameExternalServiceServer was
...
func (UnimplementedLiveGameExternalSingleServiceServer) EnterGameTry(context.Context, *SingleEnterGameTryReq) (*SingleEnterGameTryReply, error) {
	return nil, status.Error(codes.Unimplemented, "method EnterGameTry not implemented")
}
...
func RegisterLiveGameExternalSingleServiceServer(s grpc.ServiceRegistrar, srv LiveGameExternalSingleServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameExternalSingleServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedLiveGameExternalTransferServiceServer) WalletTransferInGame(context.Context, *WalletTransferInGameReq) (*WalletTransferInGameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method WalletTransferInGame not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) WalletTransferOutGame(context.Context, *WalletTransferOutGameReq) (*WalletTransferOutGameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method WalletTransferOutGame not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) GetWalletTransferBalance(context.Context, *GetWalletTransferBalanceReq) (*GetWalletTransferBalanceReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWalletTransferBalance not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) GetGameTransferOrderStatus(context.Context, *GetGameTransferOrderStatusReq) (*GetGameTransferOrderStatusReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameTransferOrderStatus not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) GetGameTransferOrderStatusV2(context.Context, *GetGameTransferOrderStatusV2Req) (*GetGameTransferOrderStatusReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameTransferOrderStatusV2 not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) GetGameTransferBetOrderList(context.Context, *GetGameTransferBetOrderListReq) (*GetGameTransferBetOrderListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameTransferBetOrderList not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) WalletTransferInGameV2(context.Context, *WalletTransferInGameReqV2) (*WalletTransferInGameReplyV2, error) {
	return nil, status.Error(codes.Unimplemented, "method WalletTransferInGameV2 not implemented")
}
func (UnimplementedLiveGameExternalTransferServiceServer) GetWalletTransferBalanceV2(context.Context, *GetWalletTransferBalanceReqV2) (*GetWalletTransferBalanceReplyV2, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWalletTransferBalanceV2 not implemented")
}
...
func RegisterLiveGameExternalTransferServiceServer(s grpc.ServiceRegistrar, srv LiveGameExternalTransferServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameExternalTransferServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedLiveGameCallbackRpcServiceServer) GetK9GameAccessKey(context.Context, *GetK9GameAccessKeyReq) (*GetK9GameAccessKeyReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetK9GameAccessKey not implemented")
}
func (UnimplementedLiveGameCallbackRpcServiceServer) GameUserBet(context.Context, *GameUserBetReq) (*GameUserBetReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameUserBet not implemented")
}
func (UnimplementedLiveGameCallbackRpcServiceServer) GameUserReward(context.Context, *GameUserRewardReq) (*GameUserRewardReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameUserReward not implemented")
}
func (UnimplementedLiveGameCallbackRpcServiceServer) GameUserBetCancel(context.Context, *GameUserBetCancelReq) (*GameUserBetCancelReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameUserBetCancel not implemented")
}
func (UnimplementedLiveGameCallbackRpcServiceServer) GameUserAdjustment(context.Context, *GameUserAdjustmentReq) (*GameUserAdjustmentReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameUserAdjustment not implemented")
}
func (UnimplementedLiveGameCallbackRpcServiceServer) TransferCallback(context.Context, *TransferCallbackReq) (*TransferCallbackReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferCallback not implemented")
}
...
func RegisterLiveGameCallbackRpcServiceServer(s grpc.ServiceRegistrar, srv LiveGameCallbackRpcServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameCallbackRpcServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
const (
	...
	LiveGameRpcInnerService_GetLotteryDrawList_FullMethodName                = "/game.v1.LiveGameRpcInnerService/GetLotteryDrawList"
)
...
func (c *liveGameRpcInnerServiceClient) GetLotteryDrawList(ctx context.Context, in *GetLotteryDrawListReq, opts ...grpc.CallOption) (*GetLotteryDrawListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLotteryDrawListReply)
	err := c.cc.Invoke(ctx, LiveGameRpcInnerService_GetLotteryDrawList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LiveGameRpcInnerServiceServer interface {
	...
	// 通过第三方游戏id获取彩票开奖结果列表
	GetLotteryDrawList(context.Context, *GetLotteryDrawListReq) (*GetLotteryDrawListReply, error)
...
func (UnimplementedLiveGameRpcInnerServiceServer) AddTripartiteTransferRecord(context.Context, *AddTripartiteTransferRecordReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddTripartiteTransferRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddTripartiteTransferRecordStatus(context.Context, *AddTripartiteTransferRecordStatusReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddTripartiteTransferRecordStatus not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) ProcessMessageTransferData(context.Context, *ProcessMessageTransferDataReq) (*ProcessMessageTransferDataReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessMessageTransferData not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) ProcessMessageTransferSend(context.Context, *ProcessMessageTransferSendReq) (*ProcessMessageTransferSendReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ProcessMessageTransferSend not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) TripartiteTransferRecordStatus(context.Context, *TripartiteTransferRecordStatusReq) (*TripartiteTransferRecord, error) {
	return nil, status.Error(codes.Unimplemented, "method TripartiteTransferRecordStatus not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) CreateCompensationFailedRecord(context.Context, *CreateCompensationRecordReq) (*CreateCompensationRecordResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateCompensationFailedRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) GetGameDetailsByThird(context.Context, *GetGameDetailsByThirdReq) (*GetGameDetailsByThirdReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameDetailsByThird not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddGameBetRecord(context.Context, *AddGameBetRecordReq) (*AddGameBetRecordReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGameBetRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddGameSettledRecord(context.Context, *AddGameSettledRecordReq) (*AddGameBetBaseReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGameSettledRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddGameCancelRecord(context.Context, *AddGameCancelRecordReq) (*AddGameBetBaseReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGameCancelRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddGameAdjustmentRecord(context.Context, *AddGameAdjustmentRecordReq) (*AddGameBetBaseReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGameAdjustmentRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddTransferGameBetRecord(context.Context, *AddTransferGameBetRecordReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddTransferGameBetRecord not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) SendGameBetBetMQ(context.Context, *SendGameBetBetMQReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SendGameBetBetMQ not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) SendGameBetBetSettlementMQ(context.Context, *SendGameBetBetSettlementMQReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SendGameBetBetSettlementMQ not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) AddRecentlyGamePlay(context.Context, *AddRecentlyGamePlayReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddRecentlyGamePlay not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) SyncGameBetSummaryToPGTask(context.Context, *GameReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncGameBetSummaryToPGTask not implemented")
}
func (UnimplementedLiveGameRpcInnerServiceServer) GetLotteryDrawList(context.Context, *GetLotteryDrawListReq) (*GetLotteryDrawListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLotteryDrawList not implemented")
}
...
func RegisterLiveGameRpcInnerServiceServer(s grpc.ServiceRegistrar, srv LiveGameRpcInnerServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameRpcInnerServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _LiveGameRpcInnerService_GetLotteryDrawList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLotteryDrawListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveGameRpcInnerServiceServer).GetLotteryDrawList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveGameRpcInnerService_GetLotteryDrawList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveGameRpcInnerServiceServer).GetLotteryDrawList(ctx, req.(*GetLotteryDrawListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveGameRpcInnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLotteryDrawList",
			Handler:    _LiveGameRpcInnerService_GetLotteryDrawList_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/game/v1/game.proto",
...
const (
	...
	LiveGameRpcService_GetPlatListSimpleByData_FullMethodName         = "/game.v1.LiveGameRpcService/GetPlatListSimpleByData"
	...
	LiveGameRpcService_GameRecommendList_FullMethodName               = "/game.v1.LiveGameRpcService/GameRecommendList"
...
type LiveGameRpcServiceClient interface {
	...
	// 通过查询游戏结果获取平台列表(简单信息)
	GetPlatListSimpleByData(ctx context.Context, in *GetPlatformListByDataReq, opts ...grpc.CallOption) (*GetPlatListSimpleByCurrReply, error)
	// 获取平台详情
	...
	// 推荐列表
	GameRecommendList(ctx context.Context, in *GetHotGameListReq, opts ...grpc.CallOption) (*GetGameDetailsListReply, error)
	// 热门游戏列表
...
func (c *liveGameRpcServiceClient) GetPlatListSimpleByData(ctx context.Context, in *GetPlatformListByDataReq, opts ...grpc.CallOption) (*GetPlatListSimpleByCurrReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPlatListSimpleByCurrReply)
	err := c.cc.Invoke(ctx, LiveGameRpcService_GetPlatListSimpleByData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveGameRpcServiceClient) GameRecommendList(ctx context.Context, in *GetHotGameListReq, opts ...grpc.CallOption) (*GetGameDetailsListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGameDetailsListReply)
	err := c.cc.Invoke(ctx, LiveGameRpcService_GameRecommendList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LiveGameRpcServiceServer interface {
	...
	// 通过查询游戏结果获取平台列表(简单信息)
	GetPlatListSimpleByData(context.Context, *GetPlatformListByDataReq) (*GetPlatListSimpleByCurrReply, error)
	// 获取平台详情
	...
	// 推荐列表
	GameRecommendList(context.Context, *GetHotGameListReq) (*GetGameDetailsListReply, error)
	// 热门游戏列表
...
func (UnimplementedLiveGameRpcServiceServer) GetGameCategoryListByCurr(context.Context, *GetCategoryListByCurrReq) (*GetCategoryListByCurrReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameCategoryListByCurr not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameCategorySimpleListByCurr(context.Context, *GetCategoryListByCurrReq) (*GetCategorySimpleListByCurrReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameCategorySimpleListByCurr not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameListByCategory(context.Context, *GetGameListByCategoryReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameListByCategory not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetPlatformListByCurr(context.Context, *GetPlatformListByCurrReq) (*GetPlatformListByCurrReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlatformListByCurr not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetPlatListSimpleByCurr(context.Context, *GetPlatformListByCurrReq) (*GetPlatListSimpleByCurrReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlatListSimpleByCurr not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetPlatListSimpleByData(context.Context, *GetPlatformListByDataReq) (*GetPlatListSimpleByCurrReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlatListSimpleByData not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetPlatformDetails(context.Context, *GamePlatformDetailsReq) (*GamePlatformDetail, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlatformDetails not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameListByPlatform(context.Context, *GetGameListByPlatformReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameListByPlatform not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameListBySearch(context.Context, *GetGameListBySearchReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameListBySearch not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameSimpleListBySearch(context.Context, *GetGameListBySearchReq) (*GetGameSimpleListBySearchReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameSimpleListBySearch not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GameAddFavorite(context.Context, *GameHandelFavoriteReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameAddFavorite not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GameRemoveFavorite(context.Context, *GameHandelFavoriteReq) (*GameReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameRemoveFavorite not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GameFavoriteList(context.Context, *GetGameFavoriteListReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameFavoriteList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GameRecommendList(context.Context, *GetHotGameListReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GameRecommendList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetHotGameList(context.Context, *GetHotGameListReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHotGameList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetRecentlyGameList(context.Context, *GetGameRecentlyListReq) (*GetGameDetailsListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecentlyGameList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetHotPlatformList(context.Context, *GetHotPlatformListReq) (*GetHotPlatformListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHotPlatformList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetGameDetails(context.Context, *GameDetailsReq) (*GameDetails, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGameDetails not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetUserFavoriteIds(context.Context, *GetUserFavoriteIdsReq) (*GetUserFavoriteIdsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserFavoriteIds not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetUserBetRecordList(context.Context, *GetUserBetRecordListReq) (*GetUserBetRecordListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserBetRecordList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetUserBetRecordSummary(context.Context, *GetUserBetRecordSummaryReq) (*GetUserBetRecordSummaryReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserBetRecordSummary not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) GetHomePlatformItems(context.Context, *GetHomeGameItemReq) (*GetHomePlatformItemsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHomePlatformItems not implemented")
}
...
func (UnimplementedLiveGameRpcServiceServer) FetchGamePlatformMeta(context.Context, *FetchGamePlatformMetaReq) (*FetchGamePlatformMetaReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchGamePlatformMeta not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) FetchHotGameList(context.Context, *FetchHotManagementReq) (*FetchHotManagementReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchHotGameList not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) FetchGameMapByIDs(context.Context, *FetchGameMapByIDReq) (*FetchGameMapByIDReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchGameMapByIDs not implemented")
}
func (UnimplementedLiveGameRpcServiceServer) FetchPlatformMapByIDs(context.Context, *FetchPlatformMapByIDReq) (*FetchPlatformMapByIDReply, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchPlatformMapByIDs not implemented")
}
...
func RegisterLiveGameRpcServiceServer(s grpc.ServiceRegistrar, srv LiveGameRpcServiceServer) {
	// If the following call panics, it indicates UnimplementedLiveGameRpcServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _LiveGameRpcService_GetPlatListSimpleByData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPlatformListByDataReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveGameRpcServiceServer).GetPlatListSimpleByData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveGameRpcService_GetPlatListSimpleByData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveGameRpcServiceServer).GetPlatListSimpleByData(ctx, req.(*GetPlatformListByDataReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LiveGameRpcService_GameRecommendList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHotGameListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveGameRpcServiceServer).GameRecommendList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveGameRpcService_GameRecommendList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveGameRpcServiceServer).GameRecommendList(ctx, req.(*GetHotGameListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveGameRpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPlatListSimpleByData",
			Handler:    _LiveGameRpcService_GetPlatListSimpleByData_Handler,
		},
		{
		...
		{
			MethodName: "GameRecommendList",
			Handler:    _LiveGameRpcService_GameRecommendList_Handler,
		},
		{
