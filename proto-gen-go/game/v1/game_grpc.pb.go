...
func (c *liveGameRpcServiceClient) GetBigWinGameList(ctx context.Context, in *BigWinGameListReq, opts ...grpc.CallOption) (*BigWinGameListReply, error) {
	...
	err := c.cc.Invoke(ctx, LiveGameRpcService_GetBigWinGameList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveGameRpcServiceClient) FetchHotGameList(ctx context.Context, in *FetchHotManagementReq, opts ...grpc.CallOption) (*FetchHotManagementReply, error) {
	...
	err := c.cc.Invoke(ctx, LiveGameRpcService_FetchHotGameList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveGameRpcServiceClient) FetchGameMapByIDs(ctx context.Context, in *FetchGameMapByIDReq, opts ...grpc.CallOption) (*FetchGameMapByIDReply, error) {
	...
	err := c.cc.Invoke(ctx, LiveGameRpcService_FetchGameMapByIDs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveGameRpcServiceClient) FetchPlatformMapByIDs(ctx context.Context, in *FetchPlatformMapByIDReq, opts ...grpc.CallOption) (*FetchPlatformMapByIDReply, error) {
	...
	err := c.cc.Invoke(ctx, LiveGameRpcService_FetchPlatformMapByIDs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
