...
var file_proto_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 124)
var file_proto_game_v1_game_proto_goTypes = []any{
	...
	(*GameSimpleDetails)(nil),                        // 74: game.v1.GameSimpleDetails
	(*GetGameDetailsListReply)(nil),                  // 75: game.v1.GetGameDetailsListReply
	(*GetGameSimpleListBySearchReply)(nil),           // 76: game.v1.GetGameSimpleListBySearchReply
	(*GetGameListByPlatformReq)(nil),                 // 77: game.v1.GetGameListByPlatformReq
	(*GamePlatformDetailsReq)(nil),                   // 78: game.v1.GamePlatformDetailsReq
	(*GetGameListBySearchReq)(nil),                   // 79: game.v1.GetGameListBySearchReq
	(*GameHandelFavoriteReq)(nil),                    // 80: game.v1.GameHandelFavoriteReq
	(*GetGameFavoriteListReq)(nil),                   // 81: game.v1.GetGameFavoriteListReq
	(*GetUserFavoriteIdsReq)(nil),                    // 82: game.v1.GetUserFavoriteIdsReq
	(*GetUserFavoriteIdsReply)(nil),                  // 83: game.v1.GetUserFavoriteIdsReply
	(*GetGameRecentlyListReq)(nil),                   // 84: game.v1.GetGameRecentlyListReq
	(*GetHotGameListReq)(nil),                        // 85: game.v1.GetHotGameListReq
	(*GetHotPlatformListReq)(nil),                    // 86: game.v1.GetHotPlatformListReq
	(*GetHotPlatformListReply)(nil),                  // 87: game.v1.GetHotPlatformListReply
	(*GameDetailsReq)(nil),                           // 88: game.v1.GameDetailsReq
	(*GetUserBetRecordListReq)(nil),                  // 89: game.v1.GetUserBetRecordListReq
	(*GetUserBetRecordListReply)(nil),                // 90: game.v1.GetUserBetRecordListReply
	(*BetRecordInfo)(nil),                            // 91: game.v1.BetRecordInfo
	(*GetUserBetRecordSummaryReq)(nil),               // 92: game.v1.GetUserBetRecordSummaryReq
	(*GetUserBetRecordSummaryReply)(nil),             // 93: game.v1.GetUserBetRecordSummaryReply
	(*BetSummaryInfo)(nil),                           // 94: game.v1.BetSummaryInfo
	(*GetHomeGameItemReq)(nil),                       // 95: game.v1.GetHomeGameItemReq
	(*PlatformDetailsList)(nil),                      // 96: game.v1.PlatformDetailsList
	(*GameDetailsList)(nil),                          // 97: game.v1.GameDetailsList
	(*GetHomePlatformItemsReply)(nil),                // 98: game.v1.GetHomePlatformItemsReply
	(*GetHomeGameItemsReply)(nil),                    // 99: game.v1.GetHomeGameItemsReply
	(*GetGameConfInfoReq)(nil),                       // 100: game.v1.GetGameConfInfoReq
	(*GetGameConfInfoReply)(nil),                     // 101: game.v1.GetGameConfInfoReply
	(*GetNewGameListReq)(nil),                        // 102: game.v1.GetNewGameListReq
	(*GetNewGameListReply)(nil),                      // 103: game.v1.GetNewGameListReply
	(*GameValueItem)(nil),                            // 104: game.v1.GameValueItem
	(*BigWinGameListReq)(nil),                        // 105: game.v1.BigWinGameListReq
	(*BigWinGameListReply)(nil),                      // 106: game.v1.BigWinGameListReply
	(*WinGameValueItem)(nil),                         // 107: game.v1.WinGameValueItem
	(*FetchGamePlatformMetaReq)(nil),                 // 108: game.v1.FetchGamePlatformMetaReq
	(*FetchGamePlatformMetaReply)(nil),               // 109: game.v1.FetchGamePlatformMetaReply
	(*FetchHotManagementReq)(nil),                    // 110: game.v1.FetchHotManagementReq
	(*FetchHotManagementReply)(nil),                  // 111: game.v1.FetchHotManagementReply
	(*GameHotManagement)(nil),                        // 112: game.v1.GameHotManagement
	(*FetchGameMapByIDReq)(nil),                      // 113: game.v1.FetchGameMapByIDReq
	(*FetchGameMapByIDReply)(nil),                    // 114: game.v1.FetchGameMapByIDReply
	(*FetchPlatformMapByIDReq)(nil),                  // 115: game.v1.FetchPlatformMapByIDReq
	(*FetchPlatformMapByIDReply)(nil),                // 116: game.v1.FetchPlatformMapByIDReply
	nil,                                              // 117: game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	(*GetGameTransferOrderStatusReplyOrderInfo)(nil), // 118: game.v1.GetGameTransferOrderStatusReply.order_info
	nil, // 119: game.v1.GetUserFavoriteIdsReply.FavoriteIdsEntry
	nil, // 120: game.v1.GetHomePlatformItemsReply.HomeItemEntry
	nil, // 121: game.v1.GetHomeGameItemsReply.HomeItemEntry
	nil, // 122: game.v1.FetchGameMapByIDReply.InfoEntry
	nil, // 123: game.v1.FetchPlatformMapByIDReply.InfoEntry
}
var file_proto_game_v1_game_proto_depIdxs = []int32{
	117, // 0: game.v1.GetGameTransferOrderStatusReply.orders:type_name -> game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	...
	73,  // 10: game.v1.GetGameDetailsListReply.rows:type_name -> game.v1.GameDetails
	74,  // 11: game.v1.GetGameSimpleListBySearchReply.rows:type_name -> game.v1.GameSimpleDetails
	119, // 12: game.v1.GetUserFavoriteIdsReply.favoriteIds:type_name -> game.v1.GetUserFavoriteIdsReply.FavoriteIdsEntry
	69,  // 13: game.v1.GetHotPlatformListReply.rows:type_name -> game.v1.GamePlatformDetail
	91,  // 14: game.v1.GetUserBetRecordListReply.rows:type_name -> game.v1.BetRecordInfo
	94,  // 15: game.v1.GetUserBetRecordSummaryReply.bet_summary_list:type_name -> game.v1.BetSummaryInfo
	69,  // 16: game.v1.PlatformDetailsList.items:type_name -> game.v1.GamePlatformDetail
	73,  // 17: game.v1.GameDetailsList.items:type_name -> game.v1.GameDetails
	120, // 18: game.v1.GetHomePlatformItemsReply.home_item:type_name -> game.v1.GetHomePlatformItemsReply.HomeItemEntry
	121, // 19: game.v1.GetHomeGameItemsReply.home_item:type_name -> game.v1.GetHomeGameItemsReply.HomeItemEntry
	104, // 20: game.v1.GetNewGameListReply.rows:type_name -> game.v1.GameValueItem
	107, // 21: game.v1.BigWinGameListReply.rows:type_name -> game.v1.WinGameValueItem
	73,  // 22: game.v1.FetchGamePlatformMetaReply.game_detail:type_name -> game.v1.GameDetails
	69,  // 23: game.v1.FetchGamePlatformMetaReply.platform_detail:type_name -> game.v1.GamePlatformDetail
	112, // 24: game.v1.FetchHotManagementReply.rows:type_name -> game.v1.GameHotManagement
	122, // 25: game.v1.FetchGameMapByIDReply.info:type_name -> game.v1.FetchGameMapByIDReply.InfoEntry
	123, // 26: game.v1.FetchPlatformMapByIDReply.info:type_name -> game.v1.FetchPlatformMapByIDReply.InfoEntry
	118, // 27: game.v1.GetGameTransferOrderStatusReply.OrdersEntry.value:type_name -> game.v1.GetGameTransferOrderStatusReply.order_info
	96,  // 28: game.v1.GetHomePlatformItemsReply.HomeItemEntry.value:type_name -> game.v1.PlatformDetailsList
	97,  // 29: game.v1.GetHomeGameItemsReply.HomeItemEntry.value:type_name -> game.v1.GameDetailsList
	73,  // 30: game.v1.FetchGameMapByIDReply.InfoEntry.value:type_name -> game.v1.GameDetails
	69,  // 31: game.v1.FetchPlatformMapByIDReply.InfoEntry.value:type_name -> game.v1.GamePlatformDetail
	...
	23,  // 41: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatusV2:input_type -> game.v1.GetGameTransferOrderStatusV2Req
	20,  // 42: game.v1.LiveGameExternalTransferService.GetGameTransferBetOrderList:input_type -> game.v1.GetGameTransferBetOrderListReq
	10,  // 43: game.v1.LiveGameExternalTransferService.WalletTransferInGameV2:input_type -> game.v1.WalletTransferInGameReqV2
	16,  // 44: game.v1.LiveGameExternalTransferService.GetWalletTransferBalanceV2:input_type -> game.v1.GetWalletTransferBalanceReqV2
	24,  // 45: game.v1.LiveGameCallbackRpcService.GetK9GameAccessKey:input_type -> game.v1.GetK9GameAccessKeyReq
	26,  // 46: game.v1.LiveGameCallbackRpcService.GameUserBet:input_type -> game.v1.GameUserBetReq
	28,  // 47: game.v1.LiveGameCallbackRpcService.GameUserReward:input_type -> game.v1.GameUserRewardReq
	30,  // 48: game.v1.LiveGameCallbackRpcService.GameUserBetCancel:input_type -> game.v1.GameUserBetCancelReq
	32,  // 49: game.v1.LiveGameCallbackRpcService.GameUserAdjustment:input_type -> game.v1.GameUserAdjustmentReq
	34,  // 50: game.v1.LiveGameCallbackRpcService.TransferCallback:input_type -> game.v1.TransferCallbackReq
	36,  // 51: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecord:input_type -> game.v1.AddTripartiteTransferRecordReq
	37,  // 52: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecordStatus:input_type -> game.v1.AddTripartiteTransferRecordStatusReq
	39,  // 53: game.v1.LiveGameRpcInnerService.ProcessMessageTransferData:input_type -> game.v1.ProcessMessageTransferDataReq
	41,  // 54: game.v1.LiveGameRpcInnerService.ProcessMessageTransferSend:input_type -> game.v1.ProcessMessageTransferSendReq
	38,  // 55: game.v1.LiveGameRpcInnerService.TripartiteTransferRecordStatus:input_type -> game.v1.TripartiteTransferRecordStatusReq
	44,  // 56: game.v1.LiveGameRpcInnerService.CreateCompensationFailedRecord:input_type -> game.v1.CreateCompensationRecordReq
	46,  // 57: game.v1.LiveGameRpcInnerService.GetGameDetailsByThird:input_type -> game.v1.GetGameDetailsByThirdReq
	49,  // 58: game.v1.LiveGameRpcInnerService.AddGameBetRecord:input_type -> game.v1.AddGameBetRecordReq
	52,  // 59: game.v1.LiveGameRpcInnerService.AddGameSettledRecord:input_type -> game.v1.AddGameSettledRecordReq
	54,  // 60: game.v1.LiveGameRpcInnerService.AddGameCancelRecord:input_type -> game.v1.AddGameCancelRecordReq
	55,  // 61: game.v1.LiveGameRpcInnerService.AddGameAdjustmentRecord:input_type -> game.v1.AddGameAdjustmentRecordReq
	56,  // 62: game.v1.LiveGameRpcInnerService.AddTransferGameBetRecord:input_type -> game.v1.AddTransferGameBetRecordReq
	57,  // 63: game.v1.LiveGameRpcInnerService.SendGameBetBetMQ:input_type -> game.v1.SendGameBetBetMQReq
	58,  // 64: game.v1.LiveGameRpcInnerService.SendGameBetBetSettlementMQ:input_type -> game.v1.SendGameBetBetSettlementMQReq
	59,  // 65: game.v1.LiveGameRpcInnerService.AddRecentlyGamePlay:input_type -> game.v1.AddRecentlyGamePlayReq
	0,   // 66: game.v1.LiveGameRpcInnerService.SyncGameBetSummaryToPGTask:input_type -> game.v1.GameReq
	60,  // 67: game.v1.LiveGameRpcService.GetGameCategoryListByCurr:input_type -> game.v1.GetCategoryListByCurrReq
	60,  // 68: game.v1.LiveGameRpcService.GetGameCategorySimpleListByCurr:input_type -> game.v1.GetCategoryListByCurrReq
	66,  // 69: game.v1.LiveGameRpcService.GetGameListByCategory:input_type -> game.v1.GetGameListByCategoryReq
	67,  // 70: game.v1.LiveGameRpcService.GetPlatformListByCurr:input_type -> game.v1.GetPlatformListByCurrReq
	67,  // 71: game.v1.LiveGameRpcService.GetPlatListSimpleByCurr:input_type -> game.v1.GetPlatformListByCurrReq
	78,  // 72: game.v1.LiveGameRpcService.GetPlatformDetails:input_type -> game.v1.GamePlatformDetailsReq
	77,  // 73: game.v1.LiveGameRpcService.GetGameListByPlatform:input_type -> game.v1.GetGameListByPlatformReq
	79,  // 74: game.v1.LiveGameRpcService.GetGameListBySearch:input_type -> game.v1.GetGameListBySearchReq
	79,  // 75: game.v1.LiveGameRpcService.GetGameSimpleListBySearch:input_type -> game.v1.GetGameListBySearchReq
	80,  // 76: game.v1.LiveGameRpcService.GameAddFavorite:input_type -> game.v1.GameHandelFavoriteReq
	80,  // 77: game.v1.LiveGameRpcService.GameRemoveFavorite:input_type -> game.v1.GameHandelFavoriteReq
	81,  // 78: game.v1.LiveGameRpcService.GameFavoriteList:input_type -> game.v1.GetGameFavoriteListReq
	85,  // 79: game.v1.LiveGameRpcService.GetHotGameList:input_type -> game.v1.GetHotGameListReq
	84,  // 80: game.v1.LiveGameRpcService.GetRecentlyGameList:input_type -> game.v1.GetGameRecentlyListReq
	86,  // 81: game.v1.LiveGameRpcService.GetHotPlatformList:input_type -> game.v1.GetHotPlatformListReq
	88,  // 82: game.v1.LiveGameRpcService.GetGameDetails:input_type -> game.v1.GameDetailsReq
	82,  // 83: game.v1.LiveGameRpcService.GetUserFavoriteIds:input_type -> game.v1.GetUserFavoriteIdsReq
	89,  // 84: game.v1.LiveGameRpcService.GetUserBetRecordList:input_type -> game.v1.GetUserBetRecordListReq
	92,  // 85: game.v1.LiveGameRpcService.GetUserBetRecordSummary:input_type -> game.v1.GetUserBetRecordSummaryReq
	95,  // 86: game.v1.LiveGameRpcService.GetHomePlatformItems:input_type -> game.v1.GetHomeGameItemReq
	95,  // 87: game.v1.LiveGameRpcService.GetHomeGameItems:input_type -> game.v1.GetHomeGameItemReq
	95,  // 88: game.v1.LiveGameRpcService.GetHomeGameList:input_type -> game.v1.GetHomeGameItemReq
	100, // 89: game.v1.LiveGameRpcService.GetGameConfInfo:input_type -> game.v1.GetGameConfInfoReq
	102, // 90: game.v1.LiveGameRpcService.GetNewGameList:input_type -> game.v1.GetNewGameListReq
	105, // 91: game.v1.LiveGameRpcService.GetBigWinGameList:input_type -> game.v1.BigWinGameListReq
	108, // 92: game.v1.LiveGameRpcService.FetchGamePlatformMeta:input_type -> game.v1.FetchGamePlatformMetaReq
	110, // 93: game.v1.LiveGameRpcService.FetchHotGameList:input_type -> game.v1.FetchHotManagementReq
	113, // 94: game.v1.LiveGameRpcService.FetchGameMapByIDs:input_type -> game.v1.FetchGameMapByIDReq
	115, // 95: game.v1.LiveGameRpcService.FetchPlatformMapByIDs:input_type -> game.v1.FetchPlatformMapByIDReq
	1,   // 96: game.v1.LiveGameExternalService.K9GameResourceListSync:output_type -> game.v1.GameReply
	1,   // 97: game.v1.LiveGameExternalService.K9GameTransferBetRecordListSync:output_type -> game.v1.GameReply
	3,   // 98: game.v1.LiveGameExternalSingleService.EnterGame:output_type -> game.v1.SingleEnterGameReply
	5,   // 99: game.v1.LiveGameExternalSingleService.EnterGameTry:output_type -> game.v1.SingleEnterGameTryReply
	7,   // 100: game.v1.LiveGameExternalTransferService.EnterGame:output_type -> game.v1.TransferEnterGameReply
	9,   // 101: game.v1.LiveGameExternalTransferService.WalletTransferInGame:output_type -> game.v1.WalletTransferInGameReply
	13,  // 102: game.v1.LiveGameExternalTransferService.WalletTransferOutGame:output_type -> game.v1.WalletTransferOutGameReply
	15,  // 103: game.v1.LiveGameExternalTransferService.GetWalletTransferBalance:output_type -> game.v1.GetWalletTransferBalanceReply
	19,  // 104: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatus:output_type -> game.v1.GetGameTransferOrderStatusReply
	19,  // 105: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatusV2:output_type -> game.v1.GetGameTransferOrderStatusReply
	22,  // 106: game.v1.LiveGameExternalTransferService.GetGameTransferBetOrderList:output_type -> game.v1.GetGameTransferBetOrderListReply
	11,  // 107: game.v1.LiveGameExternalTransferService.WalletTransferInGameV2:output_type -> game.v1.WalletTransferInGameReplyV2
	17,  // 108: game.v1.LiveGameExternalTransferService.GetWalletTransferBalanceV2:output_type -> game.v1.GetWalletTransferBalanceReplyV2
	25,  // 109: game.v1.LiveGameCallbackRpcService.GetK9GameAccessKey:output_type -> game.v1.GetK9GameAccessKeyReply
	27,  // 110: game.v1.LiveGameCallbackRpcService.GameUserBet:output_type -> game.v1.GameUserBetReply
	29,  // 111: game.v1.LiveGameCallbackRpcService.GameUserReward:output_type -> game.v1.GameUserRewardReply
	31,  // 112: game.v1.LiveGameCallbackRpcService.GameUserBetCancel:output_type -> game.v1.GameUserBetCancelReply
	33,  // 113: game.v1.LiveGameCallbackRpcService.GameUserAdjustment:output_type -> game.v1.GameUserAdjustmentReply
	35,  // 114: game.v1.LiveGameCallbackRpcService.TransferCallback:output_type -> game.v1.TransferCallbackReply
	1,   // 115: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecord:output_type -> game.v1.GameReply
	1,   // 116: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecordStatus:output_type -> game.v1.GameReply
	40,  // 117: game.v1.LiveGameRpcInnerService.ProcessMessageTransferData:output_type -> game.v1.ProcessMessageTransferDataReply
	42,  // 118: game.v1.LiveGameRpcInnerService.ProcessMessageTransferSend:output_type -> game.v1.ProcessMessageTransferSendReply
	43,  // 119: game.v1.LiveGameRpcInnerService.TripartiteTransferRecordStatus:output_type -> game.v1.TripartiteTransferRecord
	45,  // 120: game.v1.LiveGameRpcInnerService.CreateCompensationFailedRecord:output_type -> game.v1.CreateCompensationRecordResp
	47,  // 121: game.v1.LiveGameRpcInnerService.GetGameDetailsByThird:output_type -> game.v1.GetGameDetailsByThirdReply
	50,  // 122: game.v1.LiveGameRpcInnerService.AddGameBetRecord:output_type -> game.v1.AddGameBetRecordReply
	48,  // 123: game.v1.LiveGameRpcInnerService.AddGameSettledRecord:output_type -> game.v1.AddGameBetBaseReply
	48,  // 124: game.v1.LiveGameRpcInnerService.AddGameCancelRecord:output_type -> game.v1.AddGameBetBaseReply
	48,  // 125: game.v1.LiveGameRpcInnerService.AddGameAdjustmentRecord:output_type -> game.v1.AddGameBetBaseReply
	1,   // 126: game.v1.LiveGameRpcInnerService.AddTransferGameBetRecord:output_type -> game.v1.GameReply
	1,   // 127: game.v1.LiveGameRpcInnerService.SendGameBetBetMQ:output_type -> game.v1.GameReply
	1,   // 128: game.v1.LiveGameRpcInnerService.SendGameBetBetSettlementMQ:output_type -> game.v1.GameReply
	1,   // 129: game.v1.LiveGameRpcInnerService.AddRecentlyGamePlay:output_type -> game.v1.GameReply
	1,   // 130: game.v1.LiveGameRpcInnerService.SyncGameBetSummaryToPGTask:output_type -> game.v1.GameReply
	61,  // 131: game.v1.LiveGameRpcService.GetGameCategoryListByCurr:output_type -> game.v1.GetCategoryListByCurrReply
	63,  // 132: game.v1.LiveGameRpcService.GetGameCategorySimpleListByCurr:output_type -> game.v1.GetCategorySimpleListByCurrReply
	75,  // 133: game.v1.LiveGameRpcService.GetGameListByCategory:output_type -> game.v1.GetGameDetailsListReply
	68,  // 134: game.v1.LiveGameRpcService.GetPlatformListByCurr:output_type -> game.v1.GetPlatformListByCurrReply
	70,  // 135: game.v1.LiveGameRpcService.GetPlatListSimpleByCurr:output_type -> game.v1.GetPlatListSimpleByCurrReply
	69,  // 136: game.v1.LiveGameRpcService.GetPlatformDetails:output_type -> game.v1.GamePlatformDetail
	75,  // 137: game.v1.LiveGameRpcService.GetGameListByPlatform:output_type -> game.v1.GetGameDetailsListReply
	75,  // 138: game.v1.LiveGameRpcService.GetGameListBySearch:output_type -> game.v1.GetGameDetailsListReply
	76,  // 139: game.v1.LiveGameRpcService.GetGameSimpleListBySearch:output_type -> game.v1.GetGameSimpleListBySearchReply
	1,   // 140: game.v1.LiveGameRpcService.GameAddFavorite:output_type -> game.v1.GameReply
	1,   // 141: game.v1.LiveGameRpcService.GameRemoveFavorite:output_type -> game.v1.GameReply
	75,  // 142: game.v1.LiveGameRpcService.GameFavoriteList:output_type -> game.v1.GetGameDetailsListReply
	75,  // 143: game.v1.LiveGameRpcService.GetHotGameList:output_type -> game.v1.GetGameDetailsListReply
	75,  // 144: game.v1.LiveGameRpcService.GetRecentlyGameList:output_type -> game.v1.GetGameDetailsListReply
	87,  // 145: game.v1.LiveGameRpcService.GetHotPlatformList:output_type -> game.v1.GetHotPlatformListReply
	73,  // 146: game.v1.LiveGameRpcService.GetGameDetails:output_type -> game.v1.GameDetails
	83,  // 147: game.v1.LiveGameRpcService.GetUserFavoriteIds:output_type -> game.v1.GetUserFavoriteIdsReply
	90,  // 148: game.v1.LiveGameRpcService.GetUserBetRecordList:output_type -> game.v1.GetUserBetRecordListReply
	93,  // 149: game.v1.LiveGameRpcService.GetUserBetRecordSummary:output_type -> game.v1.GetUserBetRecordSummaryReply
	98,  // 150: game.v1.LiveGameRpcService.GetHomePlatformItems:output_type -> game.v1.GetHomePlatformItemsReply
	99,  // 151: game.v1.LiveGameRpcService.GetHomeGameItems:output_type -> game.v1.GetHomeGameItemsReply
	97,  // 152: game.v1.LiveGameRpcService.GetHomeGameList:output_type -> game.v1.GameDetailsList
	101, // 153: game.v1.LiveGameRpcService.GetGameConfInfo:output_type -> game.v1.GetGameConfInfoReply
	103, // 154: game.v1.LiveGameRpcService.GetNewGameList:output_type -> game.v1.GetNewGameListReply
	106, // 155: game.v1.LiveGameRpcService.GetBigWinGameList:output_type -> game.v1.BigWinGameListReply
	109, // 156: game.v1.LiveGameRpcService.FetchGamePlatformMeta:output_type -> game.v1.FetchGamePlatformMetaReply
	111, // 157: game.v1.LiveGameRpcService.FetchHotGameList:output_type -> game.v1.FetchHotManagementReply
	114, // 158: game.v1.LiveGameRpcService.FetchGameMapByIDs:output_type -> game.v1.FetchGameMapByIDReply
	116, // 159: game.v1.LiveGameRpcService.FetchPlatformMapByIDs:output_type -> game.v1.FetchPlatformMapByIDReply
	96,  // [96:160] is the sub-list for method output_type
	32,  // [32:96] is the sub-list for method input_type
