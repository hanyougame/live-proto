...
type BetRecordInfo struct {
	...
	LoseWinAmount    int64  `protobuf:"varint,13,opt,name=lose_win_amount,json=loseWinAmount,proto3" json:"lose_win_amount,omitempty"`        // 输赢金额
}
...
func (x *BetRecordInfo) GetLoseWinAmount() int64 {
	if x != nil {
		return x.LoseWinAmount
	}
	return 0
}
...
type GetUserBetRecordSummaryReply struct {
	...
	TotalOrderCount     string            `protobuf:"bytes,2,opt,name=total_order_count,json=totalOrderCount,proto3" json:"total_order_count,omitempty"`                // 注单数量
...
func (x *GetUserBetRecordSummaryReply) GetTotalOrderCount() string {
	if x != nil {
...
type BetSummaryInfo struct {
	...
	OrderCount       string `protobuf:"bytes,8,opt,name=order_count,json=orderCount,proto3" json:"order_count,omitempty"`                     // 注单数量
	BetAmount        int64  `protobuf:"varint,9,opt,name=bet_amount,json=betAmount,proto3" json:"bet_amount,omitempty"`                       // 投注金额
	LoseWinAmount    int64  `protobuf:"varint,10,opt,name=lose_win_amount,json=loseWinAmount,proto3" json:"lose_win_amount,omitempty"`        // 输赢金额
}
...
func (x *BetSummaryInfo) GetOrderCount() string {
	if x != nil {
		return x.OrderCount
	}
	return ""
...
func (x *BetSummaryInfo) GetLoseWinAmount() int64 {
	if x != nil {
		return x.LoseWinAmount
	}
	return 0
...
var file_game_v1_game_proto_rawDesc = []byte{
	...
	0x06, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x1d, 0x50, 0x72, 0x6f, 0x63,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x22, 0x4b, 0x0a, 0x10, 0x43, 0x61, 0x74,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x60, 0x0a, 0x18,
	...
	0x6d, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x22, 0xfe, 0x04,
	...
	0x70, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x22, 0xbc, 0x04,
	...
	0x28, 0x09, 0x52, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x43, 0x6f, 0x64, 0x65,
	0x22, 0x8c, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x47, 0x61, 0x6d, 0x65, 0x46, 0x61, 0x76, 0x6f,
	...
	0x38, 0x01, 0x22, 0xac, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x74, 0x47, 0x61, 0x6d,
	...
	0xc1, 0x02, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x65, 0x74, 0x52, 0x65,
	...
	0x64, 0x65, 0x72, 0x22, 0x8e, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42,
	...
	0x72, 0x6f, 0x77, 0x73, 0x22, 0xd5, 0x03, 0x0a, 0x0d, 0x42, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x6f, 0x73, 0x65, 0x5f, 0x77, 0x69, 0x6e,
	0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x6c,
	0x6f, 0x73, 0x65, 0x57, 0x69, 0x6e, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xe2, 0x01, 0x0a,
	...
	0x72, 0x22, 0xf5, 0x01, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x65, 0x74,
	...
	0x72, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	...
	0x57, 0x69, 0x6e, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf9, 0x02, 0x0a, 0x0e, 0x42, 0x65,
	...
	0x28, 0x03, 0x52, 0x09, 0x62, 0x65, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x26, 0x0a,
	0x0f, 0x6c, 0x6f, 0x73, 0x65, 0x5f, 0x77, 0x69, 0x6e, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x6c, 0x6f, 0x73, 0x65, 0x57, 0x69, 0x6e, 0x41,
	...
	0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xd1, 0x08, 0x0a, 0x17, 0x4c, 0x69,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xde, 0x09,
	...
	0x72, 0x64, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x09,
...
var file_game_v1_game_proto_goTypes = []any{
	...
	(*PlatformRedirectionBase)(nil),                  // 56: game.v1.PlatformRedirectionBase
	(*GameDetails)(nil),                              // 57: game.v1.GameDetails
	(*GetGameDetailsListReply)(nil),                  // 58: game.v1.GetGameDetailsListReply
	(*GetGameListByPlatformReq)(nil),                 // 59: game.v1.GetGameListByPlatformReq
	(*GetGameListBySearchReq)(nil),                   // 60: game.v1.GetGameListBySearchReq
	(*GameHandelFavoriteReq)(nil),                    // 61: game.v1.GameHandelFavoriteReq
	(*GetGameFavoriteListReq)(nil),                   // 62: game.v1.GetGameFavoriteListReq
	(*GetUserFavoriteIdsReq)(nil),                    // 63: game.v1.GetUserFavoriteIdsReq
	(*GetUserFavoriteIdsReply)(nil),                  // 64: game.v1.GetUserFavoriteIdsReply
	(*GetHotGameListReq)(nil),                        // 65: game.v1.GetHotGameListReq
	(*GetHotPlatformListReq)(nil),                    // 66: game.v1.GetHotPlatformListReq
	(*GetHotPlatformListReply)(nil),                  // 67: game.v1.GetHotPlatformListReply
	(*GameDetailsReq)(nil),                           // 68: game.v1.GameDetailsReq
	(*GetUserBetRecordListReq)(nil),                  // 69: game.v1.GetUserBetRecordListReq
	(*GetUserBetRecordListReply)(nil),                // 70: game.v1.GetUserBetRecordListReply
	(*BetRecordInfo)(nil),                            // 71: game.v1.BetRecordInfo
	(*GetUserBetRecordSummaryReq)(nil),               // 72: game.v1.GetUserBetRecordSummaryReq
	(*GetUserBetRecordSummaryReply)(nil),             // 73: game.v1.GetUserBetRecordSummaryReply
	(*BetSummaryInfo)(nil),                           // 74: game.v1.BetSummaryInfo
	nil,                                              // 75: game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	(*GetGameTransferOrderStatusReplyOrderInfo)(nil), // 76: game.v1.GetGameTransferOrderStatusReply.order_info
	nil, // 77: game.v1.GetUserFavoriteIdsReply.FavoriteIdsEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	75, // 0: game.v1.GetGameTransferOrderStatusReply.orders:type_name -> game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	...
	56, // 5: game.v1.GamePlatformDetail.platform_redirection:type_name -> game.v1.PlatformRedirectionBase
	57, // 6: game.v1.GetGameDetailsListReply.rows:type_name -> game.v1.GameDetails
	77, // 7: game.v1.GetUserFavoriteIdsReply.favoriteIds:type_name -> game.v1.GetUserFavoriteIdsReply.FavoriteIdsEntry
	55, // 8: game.v1.GetHotPlatformListReply.rows:type_name -> game.v1.GamePlatformDetail
	71, // 9: game.v1.GetUserBetRecordListReply.rows:type_name -> game.v1.BetRecordInfo
	74, // 10: game.v1.GetUserBetRecordSummaryReply.bet_summary_list:type_name -> game.v1.BetSummaryInfo
	76, // 11: game.v1.GetGameTransferOrderStatusReply.OrdersEntry.value:type_name -> game.v1.GetGameTransferOrderStatusReply.order_info
	0,  // 12: game.v1.LiveGameExternalService.K9GameResourceListSync:input_type -> game.v1.GameReq
	0,  // 13: game.v1.LiveGameExternalService.K9GameTransferBetRecordListSync:input_type -> game.v1.GameReq
	2,  // 14: game.v1.LiveGameExternalSingleService.EnterGame:input_type -> game.v1.SingleEnterGameReq
	4,  // 15: game.v1.LiveGameExternalSingleService.EnterGameTry:input_type -> game.v1.SingleEnterGameTryReq
	6,  // 16: game.v1.LiveGameExternalTransferService.EnterGame:input_type -> game.v1.TransferEnterGameReq
	8,  // 17: game.v1.LiveGameExternalTransferService.WalletTransferInGame:input_type -> game.v1.WalletTransferInGameReq
	10, // 18: game.v1.LiveGameExternalTransferService.WalletTransferOutGame:input_type -> game.v1.WalletTransferOutGameReq
	12, // 19: game.v1.LiveGameExternalTransferService.GetWalletTransferBalance:input_type -> game.v1.GetWalletTransferBalanceReq
	14, // 20: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatus:input_type -> game.v1.GetGameTransferOrderStatusReq
	16, // 21: game.v1.LiveGameExternalTransferService.GetGameTransferBetOrderList:input_type -> game.v1.GetGameTransferBetOrderListReq
	19, // 22: game.v1.LiveGameCallbackRpcService.GetK9GameAccessKey:input_type -> game.v1.GetK9GameAccessKeyReq
	21, // 23: game.v1.LiveGameCallbackRpcService.GameUserBet:input_type -> game.v1.GameUserBetReq
	23, // 24: game.v1.LiveGameCallbackRpcService.GameUserReward:input_type -> game.v1.GameUserRewardReq
	25, // 25: game.v1.LiveGameCallbackRpcService.GameUserBetCancel:input_type -> game.v1.GameUserBetCancelReq
	27, // 26: game.v1.LiveGameCallbackRpcService.GameUserAdjustment:input_type -> game.v1.GameUserAdjustmentReq
	29, // 27: game.v1.LiveGameCallbackRpcService.TransferCallback:input_type -> game.v1.TransferCallbackReq
	31, // 28: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecord:input_type -> game.v1.AddTripartiteTransferRecordReq
	32, // 29: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecordStatus:input_type -> game.v1.AddTripartiteTransferRecordStatusReq
	34, // 30: game.v1.LiveGameRpcInnerService.ProcessMessageTransferData:input_type -> game.v1.ProcessMessageTransferDataReq
	36, // 31: game.v1.LiveGameRpcInnerService.ProcessMessageTransferSend:input_type -> game.v1.ProcessMessageTransferSendReq
	33, // 32: game.v1.LiveGameRpcInnerService.TripartiteTransferRecordStatus:input_type -> game.v1.TripartiteTransferRecordStatusReq
	39, // 33: game.v1.LiveGameRpcInnerService.CreateCompensationFailedRecord:input_type -> game.v1.CreateCompensationRecordReq
	42, // 34: game.v1.LiveGameRpcInnerService.AddGameBetRecord:input_type -> game.v1.AddGameBetRecordReq
	44, // 35: game.v1.LiveGameRpcInnerService.AddGameSettledRecord:input_type -> game.v1.AddGameSettledRecordReq
	45, // 36: game.v1.LiveGameRpcInnerService.AddGameCancelRecord:input_type -> game.v1.AddGameCancelRecordReq
	46, // 37: game.v1.LiveGameRpcInnerService.AddGameAdjustmentRecord:input_type -> game.v1.AddGameAdjustmentRecordReq
	47, // 38: game.v1.LiveGameRpcInnerService.AddTransferGameBetRecord:input_type -> game.v1.AddTransferGameBetRecordReq
	48, // 39: game.v1.LiveGameRpcService.GetGameCategoryListByCurr:input_type -> game.v1.GetCategoryListByCurrReq
	52, // 40: game.v1.LiveGameRpcService.GetGameListByCategory:input_type -> game.v1.GetGameListByCategoryReq
	53, // 41: game.v1.LiveGameRpcService.GetPlatformListByCurr:input_type -> game.v1.GetPlatformListByCurrReq
	59, // 42: game.v1.LiveGameRpcService.GetGameListByPlatform:input_type -> game.v1.GetGameListByPlatformReq
	60, // 43: game.v1.LiveGameRpcService.GetGameListBySearch:input_type -> game.v1.GetGameListBySearchReq
	61, // 44: game.v1.LiveGameRpcService.GameAddFavorite:input_type -> game.v1.GameHandelFavoriteReq
	61, // 45: game.v1.LiveGameRpcService.GameRemoveFavorite:input_type -> game.v1.GameHandelFavoriteReq
	62, // 46: game.v1.LiveGameRpcService.GameFavoriteList:input_type -> game.v1.GetGameFavoriteListReq
	65, // 47: game.v1.LiveGameRpcService.GetHotGameList:input_type -> game.v1.GetHotGameListReq
	66, // 48: game.v1.LiveGameRpcService.GetHotPlatformList:input_type -> game.v1.GetHotPlatformListReq
	68, // 49: game.v1.LiveGameRpcService.GetGameDetails:input_type -> game.v1.GameDetailsReq
	63, // 50: game.v1.LiveGameRpcService.GetUserFavoriteIds:input_type -> game.v1.GetUserFavoriteIdsReq
	69, // 51: game.v1.LiveGameRpcService.GetUserBetRecordList:input_type -> game.v1.GetUserBetRecordListReq
	72, // 52: game.v1.LiveGameRpcService.GetUserBetRecordSummary:input_type -> game.v1.GetUserBetRecordSummaryReq
	1,  // 53: game.v1.LiveGameExternalService.K9GameResourceListSync:output_type -> game.v1.GameReply
	1,  // 54: game.v1.LiveGameExternalService.K9GameTransferBetRecordListSync:output_type -> game.v1.GameReply
	3,  // 55: game.v1.LiveGameExternalSingleService.EnterGame:output_type -> game.v1.SingleEnterGameReply
	5,  // 56: game.v1.LiveGameExternalSingleService.EnterGameTry:output_type -> game.v1.SingleEnterGameTryReply
	7,  // 57: game.v1.LiveGameExternalTransferService.EnterGame:output_type -> game.v1.TransferEnterGameReply
	9,  // 58: game.v1.LiveGameExternalTransferService.WalletTransferInGame:output_type -> game.v1.WalletTransferInGameReply
	11, // 59: game.v1.LiveGameExternalTransferService.WalletTransferOutGame:output_type -> game.v1.WalletTransferOutGameReply
	13, // 60: game.v1.LiveGameExternalTransferService.GetWalletTransferBalance:output_type -> game.v1.GetWalletTransferBalanceReply
	15, // 61: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatus:output_type -> game.v1.GetGameTransferOrderStatusReply
	18, // 62: game.v1.LiveGameExternalTransferService.GetGameTransferBetOrderList:output_type -> game.v1.GetGameTransferBetOrderListReply
	20, // 63: game.v1.LiveGameCallbackRpcService.GetK9GameAccessKey:output_type -> game.v1.GetK9GameAccessKeyReply
	22, // 64: game.v1.LiveGameCallbackRpcService.GameUserBet:output_type -> game.v1.GameUserBetReply
	24, // 65: game.v1.LiveGameCallbackRpcService.GameUserReward:output_type -> game.v1.GameUserRewardReply
	26, // 66: game.v1.LiveGameCallbackRpcService.GameUserBetCancel:output_type -> game.v1.GameUserBetCancelReply
	28, // 67: game.v1.LiveGameCallbackRpcService.GameUserAdjustment:output_type -> game.v1.GameUserAdjustmentReply
	30, // 68: game.v1.LiveGameCallbackRpcService.TransferCallback:output_type -> game.v1.TransferCallbackReply
	1,  // 69: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecord:output_type -> game.v1.GameReply
	1,  // 70: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecordStatus:output_type -> game.v1.GameReply
	35, // 71: game.v1.LiveGameRpcInnerService.ProcessMessageTransferData:output_type -> game.v1.ProcessMessageTransferDataReply
	37, // 72: game.v1.LiveGameRpcInnerService.ProcessMessageTransferSend:output_type -> game.v1.ProcessMessageTransferSendReply
	38, // 73: game.v1.LiveGameRpcInnerService.TripartiteTransferRecordStatus:output_type -> game.v1.TripartiteTransferRecord
	40, // 74: game.v1.LiveGameRpcInnerService.CreateCompensationFailedRecord:output_type -> game.v1.CreateCompensationRecordResp
	43, // 75: game.v1.LiveGameRpcInnerService.AddGameBetRecord:output_type -> game.v1.AddGameBetRecordReply
	41, // 76: game.v1.LiveGameRpcInnerService.AddGameSettledRecord:output_type -> game.v1.AddGameBetBaseReply
	41, // 77: game.v1.LiveGameRpcInnerService.AddGameCancelRecord:output_type -> game.v1.AddGameBetBaseReply
	41, // 78: game.v1.LiveGameRpcInnerService.AddGameAdjustmentRecord:output_type -> game.v1.AddGameBetBaseReply
	1,  // 79: game.v1.LiveGameRpcInnerService.AddTransferGameBetRecord:output_type -> game.v1.GameReply
	49, // 80: game.v1.LiveGameRpcService.GetGameCategoryListByCurr:output_type -> game.v1.GetCategoryListByCurrReply
	58, // 81: game.v1.LiveGameRpcService.GetGameListByCategory:output_type -> game.v1.GetGameDetailsListReply
	54, // 82: game.v1.LiveGameRpcService.GetPlatformListByCurr:output_type -> game.v1.GetPlatformListByCurrReply
	58, // 83: game.v1.LiveGameRpcService.GetGameListByPlatform:output_type -> game.v1.GetGameDetailsListReply
	58, // 84: game.v1.LiveGameRpcService.GetGameListBySearch:output_type -> game.v1.GetGameDetailsListReply
	1,  // 85: game.v1.LiveGameRpcService.GameAddFavorite:output_type -> game.v1.GameReply
	1,  // 86: game.v1.LiveGameRpcService.GameRemoveFavorite:output_type -> game.v1.GameReply
	58, // 87: game.v1.LiveGameRpcService.GameFavoriteList:output_type -> game.v1.GetGameDetailsListReply
	58, // 88: game.v1.LiveGameRpcService.GetHotGameList:output_type -> game.v1.GetGameDetailsListReply
	67, // 89: game.v1.LiveGameRpcService.GetHotPlatformList:output_type -> game.v1.GetHotPlatformListReply
	57, // 90: game.v1.LiveGameRpcService.GetGameDetails:output_type -> game.v1.GameDetails
	64, // 91: game.v1.LiveGameRpcService.GetUserFavoriteIds:output_type -> game.v1.GetUserFavoriteIdsReply
	70, // 92: game.v1.LiveGameRpcService.GetUserBetRecordList:output_type -> game.v1.GetUserBetRecordListReply
	73, // 93: game.v1.LiveGameRpcService.GetUserBetRecordSummary:output_type -> game.v1.GetUserBetRecordSummaryReply
