...
const file_game_v1_game_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\xb6\x01\n" +
	"\x16GetGameRecentlyListReq\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x03R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x03R\bpageSize\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\x03R\x06userId\x12(\n" +
	"\x10game_platform_id\x18\x04 \x01(\x03R\x0egamePlatformId\x12(\n" +
	"\x10game_category_id\x18\a \x01(\x03R\x0egameCategoryId\"\xd6\x01\n" +
	...
	"\x13game_icon_image_url\x18\x1b \x01(\tR\x10gameIconImageUrl2\xa2\x01\n" +
	...
	"\x1aSyncGameBetSummaryToPGTask\x12\x10.game.v1.GameReq\x1a\x12.game.v1.GameReply2\xd8\x10\n" +
	...
	"\x0eGetNewGameList\x12\x1a.game.v1.GetNewGameListReq\x1a\x1c.game.v1.GetNewGameListReplyB\tZ\a./pb/v1b\x06proto3"
