...
type AddTripartiteTransferRecordReq struct {
	...
	TransferInMoney    int64  `protobuf:"varint,6,opt,name=transfer_in_money,json=transferInMoney,proto3" json:"transfer_in_money,omitempty"`          // 转入金额(分)
	TransferInTime     int64  `protobuf:"varint,7,opt,name=transfer_in_time,json=transferInTime,proto3" json:"transfer_in_time,omitempty"`             // 转入时间(Unix时间戳，秒)
	TripartiteInOrder  string `protobuf:"bytes,8,opt,name=tripartite_in_order,json=tripartiteInOrder,proto3" json:"tripartite_in_order,omitempty"`     // 第三方转入订单号
	TransferOutMoney   int64  `protobuf:"varint,9,opt,name=transfer_out_money,json=transferOutMoney,proto3" json:"transfer_out_money,omitempty"`       // 转出金额(分)
	TransferOutTime    int64  `protobuf:"varint,10,opt,name=transfer_out_time,json=transferOutTime,proto3" json:"transfer_out_time,omitempty"`         // 转出时间(Unix时间戳，秒)
	TripartiteOutOrder string `protobuf:"bytes,11,opt,name=tripartite_out_order,json=tripartiteOutOrder,proto3" json:"tripartite_out_order,omitempty"` // 第三方转出订单号
...
func (x *AddTripartiteTransferRecordReq) GetTransferInMoney() int64 {
	if x != nil {
		return x.TransferInMoney
	}
	return 0
}

func (x *AddTripartiteTransferRecordReq) GetTransferInTime() int64 {
	if x != nil {
		return x.TransferInTime
	}
	return 0
}

func (x *AddTripartiteTransferRecordReq) GetTripartiteInOrder() string {
	if x != nil {
		return x.TripartiteInOrder
	}
	return ""
}

func (x *AddTripartiteTransferRecordReq) GetTransferOutMoney() int64 {
	if x != nil {
		return x.TransferOutMoney
	}
	return 0
}

func (x *AddTripartiteTransferRecordReq) GetTransferOutTime() int64 {
	if x != nil {
		return x.TransferOutTime
	}
	return 0
}

func (x *AddTripartiteTransferRecordReq) GetTripartiteOutOrder() string {
	if x != nil {
		return x.TripartiteOutOrder
	}
	return ""
}
...
type AddTripartiteTransferRecordStatusReq struct {
	...
	TransferType int64  `protobuf:"varint,2,opt,name=transfer_type,json=transferType,proto3" json:"transfer_type,omitempty"` // 转账类型（1:转入, 2:转出）
}
...
var file_game_v1_game_proto_rawDesc = []byte{
	...
	0x65, 0x49, 0x64, 0x22, 0xe6, 0x03, 0x0a, 0x1e, 0x41, 0x64, 0x64, 0x54, 0x72, 0x69, 0x70, 0x61,
	...
	,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	0x54, 0x79, 0x70, 0x65, 0x32, 0x59, 0x0a, 0x17, 0x4c, 0x69, 0x76, 0x65, 0x47, 0x61, 0x6d, 0x65,
	...
	0x72, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0xc1,
	0x07, 0x0a, 0x12, 0x4c, 0x69, 0x76, 0x65, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x70, 0x63, 0x53, 0x65,
	...
	0x61, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x32, 0xdd, 0x01, 0x0a, 0x17, 0x4c, 0x69, 0x76, 0x65, 0x47, 0x61, 0x6d, 0x65, 0x52,
...
var file_game_v1_game_proto_goTypes = []any{
	...
	nil, // 51: game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	(*GetGameTransferOrderStatusReplyOrderInfo)(nil), // 52: game.v1.GetGameTransferOrderStatusReply.order_info
	(*GetGameTransferBetOrderListReplyBetInfo)(nil),  // 53: game.v1.GetGameTransferBetOrderListReply.bet_info
}
var file_game_v1_game_proto_depIdxs = []int32{
	51, // 0: game.v1.GetGameTransferOrderStatusReply.orders:type_name -> game.v1.GetGameTransferOrderStatusReply.OrdersEntry
	53, // 1: game.v1.GetGameTransferBetOrderListReply.bet_list:type_name -> game.v1.GetGameTransferBetOrderListReply.bet_info
	...
	52, // 8: game.v1.GetGameTransferOrderStatusReply.OrdersEntry.value:type_name -> game.v1.GetGameTransferOrderStatusReply.order_info
	...
	1,  // 37: game.v1.LiveGameExternalService.K9GameResourceListSync:output_type -> game.v1.GameReply
	3,  // 38: game.v1.LiveGameExternalSingleService.EnterGame:output_type -> game.v1.SingleEnterGameReply
	5,  // 39: game.v1.LiveGameExternalSingleService.EnterGameTry:output_type -> game.v1.SingleEnterGameTryReply
	7,  // 40: game.v1.LiveGameExternalTransferService.EnterGame:output_type -> game.v1.TransferEnterGameReply
	9,  // 41: game.v1.LiveGameExternalTransferService.WalletTransferInGame:output_type -> game.v1.WalletTransferInGameReply
	11, // 42: game.v1.LiveGameExternalTransferService.WalletTransferOutGame:output_type -> game.v1.WalletTransferOutGameReply
	13, // 43: game.v1.LiveGameExternalTransferService.GetWalletTransferBalance:output_type -> game.v1.GetWalletTransferBalanceReply
	15, // 44: game.v1.LiveGameExternalTransferService.GetGameTransferOrderStatus:output_type -> game.v1.GetGameTransferOrderStatusReply
	17, // 45: game.v1.LiveGameExternalTransferService.GetGameTransferBetOrderList:output_type -> game.v1.GetGameTransferBetOrderListReply
	19, // 46: game.v1.LiveGameCallbackRpcService.GetK9GameAccessKey:output_type -> game.v1.GetK9GameAccessKeyReply
	21, // 47: game.v1.LiveGameCallbackRpcService.GameUserBet:output_type -> game.v1.GameUserBetReply
	23, // 48: game.v1.LiveGameCallbackRpcService.GameUserReward:output_type -> game.v1.GameUserRewardReply
	25, // 49: game.v1.LiveGameCallbackRpcService.GameUserBetCancel:output_type -> game.v1.GameUserBetCancelReply
	27, // 50: game.v1.LiveGameCallbackRpcService.GameUserAdjustment:output_type -> game.v1.GameUserAdjustmentReply
	29, // 51: game.v1.LiveGameCallbackRpcService.TransferCallback:output_type -> game.v1.TransferCallbackReply
	31, // 52: game.v1.LiveGameRpcService.GetGameCategoryListByCurr:output_type -> game.v1.GetCategoryListByCurrReply
	40, // 53: game.v1.LiveGameRpcService.GetGameListByCategory:output_type -> game.v1.GetGameDetailsListReply
	36, // 54: game.v1.LiveGameRpcService.GetPlatformListByCurr:output_type -> game.v1.GetPlatformListByCurrReply
	40, // 55: game.v1.LiveGameRpcService.GetGameListByPlatform:output_type -> game.v1.GetGameDetailsListReply
	40, // 56: game.v1.LiveGameRpcService.GetGameListBySearch:output_type -> game.v1.GetGameDetailsListReply
	1,  // 57: game.v1.LiveGameRpcService.GameAddFavorite:output_type -> game.v1.GameReply
	1,  // 58: game.v1.LiveGameRpcService.GameRemoveFavorite:output_type -> game.v1.GameReply
	40, // 59: game.v1.LiveGameRpcService.GameFavoriteList:output_type -> game.v1.GetGameDetailsListReply
	40, // 60: game.v1.LiveGameRpcService.GetHotGameList:output_type -> game.v1.GetGameDetailsListReply
	47, // 61: game.v1.LiveGameRpcService.GetHotPlatformList:output_type -> game.v1.GetHotPlatformListReply
	39, // 62: game.v1.LiveGameRpcService.GetGameDetails:output_type -> game.v1.GameDetails
	1,  // 63: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecord:output_type -> game.v1.GameReply
	1,  // 64: game.v1.LiveGameRpcInnerService.AddTripartiteTransferRecordStatus:output_type -> game.v1.GameReply
