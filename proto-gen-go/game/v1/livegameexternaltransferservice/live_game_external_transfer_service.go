...
// 查询用户游戏转账（转入、转出）订单状态  V2
func (m *defaultLiveGameExternalTransferService) GetGameTransferOrderStatusV2(ctx context.Context, in *GetGameTransferOrderStatusV2Req, opts ...grpc.CallOption) (*GetGameTransferOrderStatusReply, error) {
	client := v1.NewLiveGameExternalTransferServiceClient(m.cli.Conn())
	return client.GetGameTransferOrderStatusV2(ctx, in, opts...)
}
