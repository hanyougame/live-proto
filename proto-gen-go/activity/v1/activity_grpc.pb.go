...
const (
	...
	LiveActivityInnerService_ReceivePromotionReward_FullMethodName      = "/activity.v1.LiveActivityInnerService/ReceivePromotionReward"
...
func (c *liveActivityInnerServiceClient) ReceivePromotionReward(ctx context.Context, in *PromotionRewardReceiveReq, opts ...grpc.CallOption) (*PromotionRewardReceiveReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromotionRewardReceiveReply)
	err := c.cc.Invoke(ctx, LiveActivityInnerService_ReceivePromotionReward_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveActivityInnerServiceClient) PromotionActivityRiskCheck(ctx context.Context, in *ActivityRiskCheckReq, opts ...grpc.CallOption) (*PromotionRiskCheckReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromotionRiskCheckReply)
	err := c.cc.Invoke(ctx, LiveActivityInnerService_PromotionActivityRiskCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveActivityInnerServiceClient) ApplyPromotionReward(ctx context.Context, in *PromotionRewardApplyReq, opts ...grpc.CallOption) (*PromotionRewardApplyReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromotionRewardApplyReply)
	err := c.cc.Invoke(ctx, LiveActivityInnerService_ApplyPromotionReward_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *liveActivityInnerServiceClient) PromotionTaskRiskCheck(ctx context.Context, in *TaskRiskCheckReq, opts ...grpc.CallOption) (*PromotionRiskCheckReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromotionRiskCheckReply)
	err := c.cc.Invoke(ctx, LiveActivityInnerService_PromotionTaskRiskCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LiveActivityInnerServiceServer interface {
	...
	// 领取优惠奖励
	ReceivePromotionReward(context.Context, *PromotionRewardReceiveReq) (*PromotionRewardReceiveReply, error)
	// 活动优惠奖励风控校验
	PromotionActivityRiskCheck(context.Context, *ActivityRiskCheckReq) (*PromotionRiskCheckReply, error)
	// 申请优惠奖励
...
func (UnimplementedLiveActivityInnerServiceServer) ReceivePromotionReward(context.Context, *PromotionRewardReceiveReq) (*PromotionRewardReceiveReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReceivePromotionReward not implemented")
}
func (UnimplementedLiveActivityInnerServiceServer) PromotionActivityRiskCheck(context.Context, *ActivityRiskCheckReq) (*PromotionRiskCheckReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PromotionActivityRiskCheck not implemented")
}
func (UnimplementedLiveActivityInnerServiceServer) ApplyPromotionReward(context.Context, *PromotionRewardApplyReq) (*PromotionRewardApplyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ApplyPromotionReward not implemented")
}
...
func _LiveActivityInnerService_ReceivePromotionReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PromotionRewardReceiveReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveActivityInnerServiceServer).ReceivePromotionReward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveActivityInnerService_ReceivePromotionReward_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveActivityInnerServiceServer).ReceivePromotionReward(ctx, req.(*PromotionRewardReceiveReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveActivityInnerService_PromotionActivityRiskCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ActivityRiskCheckReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveActivityInnerServiceServer).PromotionActivityRiskCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveActivityInnerService_PromotionActivityRiskCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveActivityInnerServiceServer).PromotionActivityRiskCheck(ctx, req.(*ActivityRiskCheckReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveActivityInnerService_ApplyPromotionReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PromotionRewardApplyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveActivityInnerServiceServer).ApplyPromotionReward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveActivityInnerService_ApplyPromotionReward_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveActivityInnerServiceServer).ApplyPromotionReward(ctx, req.(*PromotionRewardApplyReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _LiveActivityInnerService_PromotionTaskRiskCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskRiskCheckReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveActivityInnerServiceServer).PromotionTaskRiskCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveActivityInnerService_PromotionTaskRiskCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveActivityInnerServiceServer).PromotionTaskRiskCheck(ctx, req.(*TaskRiskCheckReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveActivityInnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReceivePromotionReward",
			Handler:    _LiveActivityInnerService_ReceivePromotionReward_Handler,
		},
		{
			MethodName: "PromotionActivityRiskCheck",
			Handler:    _LiveActivityInnerService_PromotionActivityRiskCheck_Handler,
		},
		{
			MethodName: "ApplyPromotionReward",
			Handler:    _LiveActivityInnerService_ApplyPromotionReward_Handler,
		},
		{
