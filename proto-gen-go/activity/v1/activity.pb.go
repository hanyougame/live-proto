...
const file_activity_v1_activity_proto_rawDesc = "" +
	...
	"\x11SPIN_TYPE_DIAMOND\x10\x032\xda\b\n" +
...
var file_activity_v1_activity_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_activity_v1_activity_proto_goTypes = []any{
	...
	(*RedPacketCountdownEventReq)(nil),       // 21: activity.v1.RedPacketCountdownEventReq
	(*LuckySpinEventReq)(nil),                // 22: activity.v1.LuckySpinEventReq
	(*CheckUserRedPacketConditionReq)(nil),   // 23: activity.v1.CheckUserRedPacketConditionReq
	(*CheckUserRedPacketConditionReply)(nil), // 24: activity.v1.CheckUserRedPacketConditionReply
	(*IncreaseUserRedPacketCountReq)(nil),    // 25: activity.v1.IncreaseUserRedPacketCountReq
	nil,                                      // 26: activity.v1.LuckyPointsUsedItem.DetailEntry
	nil,                                      // 27: activity.v1.LuckyPointsAddItem.DetailEntry
	nil,                                      // 28: activity.v1.UseLuckyPointReq.DetailEntry
	nil,                                      // 29: activity.v1.AddLuckyValReq.DetailEntry
	nil,                                      // 30: activity.v1.CheckUserRedPacketConditionReply.UserPacketConditionsEntry
}
var file_activity_v1_activity_proto_depIdxs = []int32{
	...
	26, // 4: activity.v1.LuckyPointsUsedItem.detail:type_name -> activity.v1.LuckyPointsUsedItem.DetailEntry
	10, // 5: activity.v1.LuckyPointsUsedListReply.data:type_name -> activity.v1.LuckyPointsUsedItem
	27, // 6: activity.v1.LuckyPointsAddItem.detail:type_name -> activity.v1.LuckyPointsAddItem.DetailEntry
	...
	28, // 9: activity.v1.UseLuckyPointReq.detail:type_name -> activity.v1.UseLuckyPointReq.DetailEntry
	17, // 10: activity.v1.GetLuckyPointReply.data:type_name -> activity.v1.GetLuckyPointItem
	29, // 11: activity.v1.AddLuckyValReq.detail:type_name -> activity.v1.AddLuckyValReq.DetailEntry
	0,  // 12: activity.v1.LuckySpinEventReq.type:type_name -> activity.v1.EventType
	30, // 13: activity.v1.CheckUserRedPacketConditionReply.user_packet_conditions:type_name -> activity.v1.CheckUserRedPacketConditionReply.UserPacketConditionsEntry
	20, // 14: activity.v1.LiveActivityInnerService.RedPacketCampaignEvent:input_type -> activity.v1.RedPacketCampaignEventReq
	21, // 15: activity.v1.LiveActivityInnerService.RedPacketCountdownEvent:input_type -> activity.v1.RedPacketCountdownEventReq
	23, // 16: activity.v1.LiveActivityInnerService.CheckUserRedPacketCondition:input_type -> activity.v1.CheckUserRedPacketConditionReq
	25, // 17: activity.v1.LiveActivityInnerService.IncreaseUserRedPacketCount:input_type -> activity.v1.IncreaseUserRedPacketCountReq
	22, // 18: activity.v1.LiveActivityInnerService.LuckySpinEvent:input_type -> activity.v1.LuckySpinEventReq
	19, // 19: activity.v1.LiveActivityInnerService.AddLuckyPoint:input_type -> activity.v1.AddLuckyValReq
	15, // 20: activity.v1.LiveActivityInnerService.UseLuckyPoint:input_type -> activity.v1.UseLuckyPointReq
	16, // 21: activity.v1.LiveActivityInnerService.GetUserLuckyPoint:input_type -> activity.v1.GetLuckyPointReq
	8,  // 22: activity.v1.LiveActivityInnerService.LuckyPointsAddList:input_type -> activity.v1.GetLuckyPointListReq
	8,  // 23: activity.v1.LiveActivityInnerService.LuckyPointsUsedList:input_type -> activity.v1.GetLuckyPointListReq
	9,  // 24: activity.v1.LiveActivityInnerService.RewardList:input_type -> activity.v1.RewardListReq
	4,  // 25: activity.v1.LiveActivityInnerService.GetUserInviteCount:input_type -> activity.v1.GetUserInviteCountReq
	3,  // 26: activity.v1.LiveActivityInnerService.RedPacketCampaignEvent:output_type -> activity.v1.ActivityReply
	3,  // 27: activity.v1.LiveActivityInnerService.RedPacketCountdownEvent:output_type -> activity.v1.ActivityReply
	24, // 28: activity.v1.LiveActivityInnerService.CheckUserRedPacketCondition:output_type -> activity.v1.CheckUserRedPacketConditionReply
	3,  // 29: activity.v1.LiveActivityInnerService.IncreaseUserRedPacketCount:output_type -> activity.v1.ActivityReply
	3,  // 30: activity.v1.LiveActivityInnerService.LuckySpinEvent:output_type -> activity.v1.ActivityReply
	3,  // 31: activity.v1.LiveActivityInnerService.AddLuckyPoint:output_type -> activity.v1.ActivityReply
	3,  // 32: activity.v1.LiveActivityInnerService.UseLuckyPoint:output_type -> activity.v1.ActivityReply
	18, // 33: activity.v1.LiveActivityInnerService.GetUserLuckyPoint:output_type -> activity.v1.GetLuckyPointReply
	13, // 34: activity.v1.LiveActivityInnerService.LuckyPointsAddList:output_type -> activity.v1.LuckyPointsAddListReply
	11, // 35: activity.v1.LiveActivityInnerService.LuckyPointsUsedList:output_type -> activity.v1.LuckyPointsUsedListReply
	6,  // 36: activity.v1.LiveActivityInnerService.RewardList:output_type -> activity.v1.RewardListReply
	5,  // 37: activity.v1.LiveActivityInnerService.GetUserInviteCount:output_type -> activity.v1.GetUserInviteCountReply
