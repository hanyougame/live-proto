...
func (c *liveManageRpcServiceClient) SmsStatusQuery(ctx context.Context, in *SmsStatusQueryReq, opts ...grpc.CallOption) (*SmsStatusQueryResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SmsStatusQueryResp)
	err := c.cc.Invoke(ctx, LiveManageRpcService_SmsStatusQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLiveManageRpcServiceServer) SmsStatusQuery(context.Context, *SmsStatusQueryReq) (*SmsStatusQueryResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SmsStatusQuery not implemented")
}
...
func _LiveManageRpcService_SmsStatusQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SmsStatusQueryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LiveManageRpcServiceServer).SmsStatusQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LiveManageRpcService_SmsStatusQuery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiveManageRpcServiceServer).SmsStatusQuery(ctx, req.(*SmsStatusQueryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LiveManageRpcService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SmsStatusQuery",
			Handler:    _LiveManageRpcService_SmsStatusQuery_Handler,
		},
		{
