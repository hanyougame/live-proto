...
type SmsStatusQueryReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SmsCodes      []string               `protobuf:"bytes,1,rep,name=sms_codes,json=smsCodes,proto3" json:"sms_codes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SmsStatusQueryReq) Reset() {
	*x = SmsStatusQueryReq{}
...
func (x *SmsStatusQueryReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SmsStatusQueryReq) ProtoMessage() {}

func (x *SmsStatusQueryReq) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SmsStatusQueryReq.ProtoReflect.Descriptor instead.
func (*SmsStatusQueryReq) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{18}
}

func (x *SmsStatusQueryReq) GetSmsCodes() []string {
	if x != nil {
		return x.SmsCodes
	}
	return nil
...
type SmsStatusQueryResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          []*SmsStatusQueryItem  `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SmsStatusQueryResp) Reset() {
	*x = SmsStatusQueryResp{}
	mi := &file_manage_v1_manage_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SmsStatusQueryResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SmsStatusQueryResp) ProtoMessage() {}

func (x *SmsStatusQueryResp) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SmsStatusQueryResp.ProtoReflect.Descriptor instead.
func (*SmsStatusQueryResp) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{19}
}

func (x *SmsStatusQueryResp) GetList() []*SmsStatusQueryItem {
	if x != nil {
		return x.List
	}
	return nil
...
type SmsStatusQueryItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ThirdOrderNo  string                 `protobuf:"bytes,1,opt,name=third_order_no,json=thirdOrderNo,proto3" json:"third_order_no,omitempty"` // 三方单号
	Status        int64                  `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"`                                  // 状态 1-发送成功 2-发送失败
	Phone         string                 `protobuf:"bytes,4,opt,name=phone,proto3" json:"phone,omitempty"`                                     // 发送手机号
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SmsStatusQueryItem) Reset() {
	*x = SmsStatusQueryItem{}
	mi := &file_manage_v1_manage_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SmsStatusQueryItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SmsStatusQueryItem) ProtoMessage() {}

func (x *SmsStatusQueryItem) ProtoReflect() protoreflect.Message {
	mi := &file_manage_v1_manage_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SmsStatusQueryItem.ProtoReflect.Descriptor instead.
func (*SmsStatusQueryItem) Descriptor() ([]byte, []int) {
	return file_manage_v1_manage_proto_rawDescGZIP(), []int{20}
}

func (x *SmsStatusQueryItem) GetThirdOrderNo() string {
	if x != nil {
		return x.ThirdOrderNo
	}
	return ""
...
func (x *SmsStatusQueryItem) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *SmsStatusQueryItem) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
const file_manage_v1_manage_proto_rawDesc = "" +
	...
	"\n" +
	"short_urls\x18\x01 \x03(\tR\tshortUrls\"0\n" +
	"\x11SmsStatusQueryReq\x12\x1b\n" +
	"\tsms_codes\x18\x01 \x03(\tR\bsmsCodes\"G\n" +
	"\x12SmsStatusQueryResp\x121\n" +
	"\x04list\x18\x01 \x03(\v2\x1d.manage.v1.SmsStatusQueryItemR\x04list\"h\n" +
...
var file_manage_v1_manage_proto_depIdxs = []int32{
	...
	4,  // 7: manage.v1.LiveManageRpcService.GetCurrInfoById:input_type -> manage.v1.GetCurrInfoByIDReq
	6,  // 8: manage.v1.LiveManageRpcService.GetIPGeolocation:input_type -> manage.v1.GetIPGeolocationReq
	8,  // 9: manage.v1.LiveManageRpcService.BatchGetIPGeolocation:input_type -> manage.v1.BatchGetIPGeolocationReq
	10, // 10: manage.v1.LiveManageRpcService.SendSms:input_type -> manage.v1.SendSmsReq
	12, // 11: manage.v1.LiveManageRpcService.SmsBalance:input_type -> manage.v1.SmsBalanceReq
