...
const (
	AuditStatus_AuditStatus_             AuditStatus = 0 // _
	AuditStatus_AuditStatusNotStart      AuditStatus = 1 // 未开始
	AuditStatus_AuditStatusDoing         AuditStatus = 2 // 进行中
	AuditStatus_AuditStatusFinished      AuditStatus = 3 // 已完成
	AuditStatus_AuditStatusManualRelease AuditStatus = 4 // 人工解除
	AuditStatus_AuditStatusSystemRelease AuditStatus = 5 // 系统解除
	AuditStatus_AuditStatusGiveUp        AuditStatus = 6 // 已放弃
)
...
var (
	AuditStatus_name = map[int32]string{
		0: "AuditStatus_",
		1: "AuditStatusNotStart",
		2: "AuditStatusDoing",
		3: "AuditStatusFinished",
		4: "AuditStatusManualRelease",
		5: "AuditStatusSystemRelease",
		6: "AuditStatusGiveUp",
	}
	AuditStatus_value = map[string]int32{
		"AuditStatus_":             0,
		"AuditStatusNotStart":      1,
		"AuditStatusDoing":         2,
		"AuditStatusFinished":      3,
		"AuditStatusManualRelease": 4,
		"AuditStatusSystemRelease": 5,
		"AuditStatusGiveUp":        6,
	}
)
...
func (WithdrawLimitType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_finance_v1_finance_proto_enumTypes[7].Descriptor()
}

func (WithdrawLimitType) Type() protoreflect.EnumType {
	return &file_proto_finance_v1_finance_proto_enumTypes[7]
}
...
type GetAuditListReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                      // 用户Id
	Status        []AuditStatus          `protobuf:"varint,2,rep,packed,name=status,proto3,enum=finance.v1.AuditStatus" json:"status,omitempty"` // 稽核状态
...
func (x *GetAuditListReq) GetStatus() []AuditStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_proto_finance_v1_finance_proto_rawDesc = []byte{
	...
	0x72, 0x6c, 0x22, 0x99, 0x04, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x41, 0x75, 0x64, 0x69, 0x74, 0x52,
	...
	0x61, 0x6d, 0x65, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x49, 0x64, 0x73, 0x22, 0x29,
	0x0a, 0x0c, 0x41, 0x64, 0x64, 0x41, 0x75, 0x64, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x19,
	0x0a, 0x08, 0x61, 0x75, 0x64, 0x69, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x07, 0x61, 0x75, 0x64, 0x69, 0x74, 0x49, 0x64, 0x22, 0xa1, 0x01, 0x0a, 0x14, 0x55, 0x70,
	...
	0x75, 0x64, 0x69, 0x74, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0b, 0x61, 0x75, 0x64, 0x69, 0x74, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23,
	...
	0x61, 0x6d, 0x65, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x49, 0x64, 0x22, 0x17, 0x0a,
	...
	,
	...
	0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x8c, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x66, 0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x41, 0x75, 0x64, 0x69, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06,
	...
	0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xa3, 0x02, 0x0a, 0x09, 0x41, 0x75, 0x64, 0x69,
	...
	0x6e, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x5e, 0x0a,
	0x10, 0x47, 0x65, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x34, 0x0a, 0x0a, 0x61, 0x75, 0x64, 0x69, 0x74,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x66, 0x69,
	0x6e, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x75, 0x64, 0x69, 0x74, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x09, 0x61, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x94, 0x02,
	...
	0x54, 0x5f, 0x57, 0x41, 0x49, 0x54, 0x10, 0x04, 0x2a, 0x8f, 0x03, 0x0a, 0x09, 0x41, 0x75, 0x64,
	...
	0x75, 0x6e, 0x64, 0x10, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x41, 0x75, 0x64, 0x69, 0x74, 0x53, 0x75,
	0x62, 0x54, 0x79, 0x70, 0x65, 0x42, 0x6f, 0x78, 0x10, 0x10, 0x2a, 0xc5, 0x22, 0x0a, 0x0c, 0x41,
	...
	,
	...
	0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x52, 0x65, 0x73, 0x70, 0x32, 0xc4, 0x02, 0x0a, 0x13,
...
var file_proto_finance_v1_finance_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_proto_finance_v1_finance_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_proto_finance_v1_finance_proto_goTypes = []any{
	...
	(AuditStatus)(0),                      // 6: finance.v1.AuditStatus
	(WithdrawLimitType)(0),                // 7: finance.v1.WithdrawLimitType
	(*PayInReq)(nil),                      // 8: finance.v1.PayInReq
	(*PayInResp)(nil),                     // 9: finance.v1.PayInResp
	(*PayOutReq)(nil),                     // 10: finance.v1.PayOutReq
	(*PayOutResp)(nil),                    // 11: finance.v1.PayOutResp
	(*PayInStatusReq)(nil),                // 12: finance.v1.PayInStatusReq
	(*PayInStatusResp)(nil),               // 13: finance.v1.PayInStatusResp
	(*PayOutStatusReq)(nil),               // 14: finance.v1.PayOutStatusReq
	(*PayOutStatusResp)(nil),              // 15: finance.v1.PayOutStatusResp
	(*BalanceReq)(nil),                    // 16: finance.v1.BalanceReq
	(*BalanceResp)(nil),                   // 17: finance.v1.BalanceResp
	(*RechargeReq)(nil),                   // 18: finance.v1.RechargeReq
	(*RechargeResp)(nil),                  // 19: finance.v1.RechargeResp
	(*AddAuditReq)(nil),                   // 20: finance.v1.AddAuditReq
	(*AddAuditResp)(nil),                  // 21: finance.v1.AddAuditResp
	(*UpdateAuditAmountReq)(nil),          // 22: finance.v1.UpdateAuditAmountReq
	(*UpdateAuditAmountResp)(nil),         // 23: finance.v1.UpdateAuditAmountResp
	(*GetAuditInfoReq)(nil),               // 24: finance.v1.GetAuditInfoReq
	(*GetAuditInfoResp)(nil),              // 25: finance.v1.GetAuditInfoResp
	(*GetAuditListReq)(nil),               // 26: finance.v1.GetAuditListReq
	(*AuditInfo)(nil),                     // 27: finance.v1.AuditInfo
	(*GetAuditListResp)(nil),              // 28: finance.v1.GetAuditListResp
	(*AddWithdrawLimitReq)(nil),           // 29: finance.v1.AddWithdrawLimitReq
	(*AddWithdrawLimitResp)(nil),          // 30: finance.v1.AddWithdrawLimitResp
	(*UpdateWithdrawLimitAmountReq)(nil),  // 31: finance.v1.UpdateWithdrawLimitAmountReq
	(*UpdateWithdrawLimitAmountResp)(nil), // 32: finance.v1.UpdateWithdrawLimitAmountResp
	(*WithdrawReq)(nil),                   // 33: finance.v1.WithdrawReq
	(*WithdrawResp)(nil),                  // 34: finance.v1.WithdrawResp
	(*ExchangeRateReq)(nil),               // 35: finance.v1.ExchangeRateReq
	(*ExchangeRateResp)(nil),              // 36: finance.v1.ExchangeRateResp
}
var file_proto_finance_v1_finance_proto_depIdxs = []int32{
	...
	6,  // 6: finance.v1.GetAuditListReq.status:type_name -> finance.v1.AuditStatus
	27, // 7: finance.v1.GetAuditListResp.audit_list:type_name -> finance.v1.AuditInfo
	7,  // 8: finance.v1.AddWithdrawLimitReq.withdraw_limit_type:type_name -> finance.v1.WithdrawLimitType
	8,  // 9: finance.v1.LivePaymentRpcService.PayIn:input_type -> finance.v1.PayInReq
	10, // 10: finance.v1.LivePaymentRpcService.PayOut:input_type -> finance.v1.PayOutReq
	12, // 11: finance.v1.LivePaymentRpcService.PayInStatus:input_type -> finance.v1.PayInStatusReq
	14, // 12: finance.v1.LivePaymentRpcService.PayOutStatus:input_type -> finance.v1.PayOutStatusReq
	16, // 13: finance.v1.LivePaymentRpcService.Balance:input_type -> finance.v1.BalanceReq
	18, // 14: finance.v1.LivePaymentRpcService.Recharge:input_type -> finance.v1.RechargeReq
	33, // 15: finance.v1.LivePaymentRpcService.Withdraw:input_type -> finance.v1.WithdrawReq
	20, // 16: finance.v1.LiveAuditRpcService.AddAudit:input_type -> finance.v1.AddAuditReq
	22, // 17: finance.v1.LiveAuditRpcService.UpdateAuditAmount:input_type -> finance.v1.UpdateAuditAmountReq
	24, // 18: finance.v1.LiveAuditRpcService.GetAuditInfo:input_type -> finance.v1.GetAuditInfoReq
	26, // 19: finance.v1.LiveAuditRpcService.GetAuditList:input_type -> finance.v1.GetAuditListReq
	29, // 20: finance.v1.LiveWithdrawLimitRpcService.AddWithdrawLimit:input_type -> finance.v1.AddWithdrawLimitReq
	31, // 21: finance.v1.LiveWithdrawLimitRpcService.UpdateWithdrawLimitAmount:input_type -> finance.v1.UpdateWithdrawLimitAmountReq
	35, // 22: finance.v1.LiveExchangeRateRpcService.GetExchangeRate:input_type -> finance.v1.ExchangeRateReq
	9,  // 23: finance.v1.LivePaymentRpcService.PayIn:output_type -> finance.v1.PayInResp
	11, // 24: finance.v1.LivePaymentRpcService.PayOut:output_type -> finance.v1.PayOutResp
	13, // 25: finance.v1.LivePaymentRpcService.PayInStatus:output_type -> finance.v1.PayInStatusResp
	15, // 26: finance.v1.LivePaymentRpcService.PayOutStatus:output_type -> finance.v1.PayOutStatusResp
	17, // 27: finance.v1.LivePaymentRpcService.Balance:output_type -> finance.v1.BalanceResp
	19, // 28: finance.v1.LivePaymentRpcService.Recharge:output_type -> finance.v1.RechargeResp
	34, // 29: finance.v1.LivePaymentRpcService.Withdraw:output_type -> finance.v1.WithdrawResp
	21, // 30: finance.v1.LiveAuditRpcService.AddAudit:output_type -> finance.v1.AddAuditResp
	23, // 31: finance.v1.LiveAuditRpcService.UpdateAuditAmount:output_type -> finance.v1.UpdateAuditAmountResp
	25, // 32: finance.v1.LiveAuditRpcService.GetAuditInfo:output_type -> finance.v1.GetAuditInfoResp
	28, // 33: finance.v1.LiveAuditRpcService.GetAuditList:output_type -> finance.v1.GetAuditListResp
	30, // 34: finance.v1.LiveWithdrawLimitRpcService.AddWithdrawLimit:output_type -> finance.v1.AddWithdrawLimitResp
	32, // 35: finance.v1.LiveWithdrawLimitRpcService.UpdateWithdrawLimitAmount:output_type -> finance.v1.UpdateWithdrawLimitAmountResp
	36, // 36: finance.v1.LiveExchangeRateRpcService.GetExchangeRate:output_type -> finance.v1.ExchangeRateResp
