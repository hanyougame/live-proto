...
// 更新提现稽核信息（单笔稽核模式）
func (m *defaultLiveAuditRpcService) UpdateWithdrawAmount(ctx context.Context, in *UpdateWithdrawAmountReq, opts ...grpc.CallOption) (*UpdateWithdrawAmountResp, error) {
	client := v1.NewLiveAuditRpcServiceClient(m.cli.Conn())
	return client.UpdateWithdrawAmount(ctx, in, opts...)
}
