...
// 	protoc        v6.32.0
// source: temporal/v1/temporal_types_v2.proto
...
func (ExecutionMode) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[0].Descriptor()
}

func (ExecutionMode) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[0]
}
...
func (ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{0}
}
...
func (ControlOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[1].Descriptor()
}

func (ControlOperation) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[1]
}
...
func (ControlOperation) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{1}
}
...
func (ControlOperationResult) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[2].Descriptor()
}

func (ControlOperationResult) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[2]
}
...
func (ControlOperationResult) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{2}
}
...
func (QueryType) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[3].Descriptor()
}

func (QueryType) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[3]
}
...
func (QueryType) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{3}
}
...
func (WorkflowState) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[4].Descriptor()
}

func (WorkflowState) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[4]
}
...
func (WorkflowState) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{4}
}
...
func (ScheduleOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[5].Descriptor()
}

func (ScheduleOperation) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[5]
}
...
func (ScheduleOperation) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{5}
}
...
func (OverlapPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[6].Descriptor()
}

func (OverlapPolicy) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[6]
}
...
func (OverlapPolicy) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{6}
}
...
func (ScheduleState) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[7].Descriptor()
}

func (ScheduleState) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[7]
}
...
func (ScheduleState) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{7}
}
...
func (SearchAttributeCategory) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[8].Descriptor()
}

func (SearchAttributeCategory) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[8]
}
...
func (SearchAttributeCategory) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{8}
}
...
func (SearchAttributeType) Descriptor() protoreflect.EnumDescriptor {
	return file_temporal_v1_temporal_types_v2_proto_enumTypes[9].Descriptor()
}

func (SearchAttributeType) Type() protoreflect.EnumType {
	return &file_temporal_v1_temporal_types_v2_proto_enumTypes[9]
}
...
func (SearchAttributeType) EnumDescriptor() ([]byte, []int) {
	return file_temporal_v1_temporal_types_v2_proto_rawDescGZIP(), []int{9}
}
...
func (x *WorkflowOpts) Reset() {
	*x = WorkflowOpts{}
	mi := &file_temporal_v1_temporal_types_v2_proto_msgTypes[0]
...
func (x *RetryPolicyOpt) Reset() {
	*x = RetryPolicyOpt{}
	mi := &file_temporal_v1_temporal_types_v2_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_temporal_v1_temporal_types_v2_proto protoreflect.FileDescriptor

const file_temporal_v1_temporal_types_v2_proto_rawDesc = "" +
	"\n" +
	"#temporal/v1/temporal_types_v2.proto\x12\vtemporal.v1\"\xec\x01\n" +
	"\fWorkflowOpts\x12:\n" +
	...
	"\"SEARCH_ATTRIBUTE_TYPE_KEYWORD_LIST\x10\aB;Z9github.com/hanyougame/live-proto/proto-gen-go/temporal/v1b\x06proto3"

var (
	file_temporal_v1_temporal_types_v2_proto_rawDescOnce sync.Once
	file_temporal_v1_temporal_types_v2_proto_rawDescData []byte
)

func file_temporal_v1_temporal_types_v2_proto_rawDescGZIP() []byte {
	file_temporal_v1_temporal_types_v2_proto_rawDescOnce.Do(func() {
		file_temporal_v1_temporal_types_v2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_temporal_v1_temporal_types_v2_proto_rawDesc), len(file_temporal_v1_temporal_types_v2_proto_rawDesc)))
	})
	return file_temporal_v1_temporal_types_v2_proto_rawDescData
}

var file_temporal_v1_temporal_types_v2_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_temporal_v1_temporal_types_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_temporal_v1_temporal_types_v2_proto_goTypes = []any{
	...
	(*WorkflowOpts)(nil),         // 10: temporal.v1.WorkflowOpts
	(*RetryPolicyOpt)(nil),       // 11: temporal.v1.RetryPolicyOpt
}
var file_temporal_v1_temporal_types_v2_proto_depIdxs = []int32{
	11, // 0: temporal.v1.WorkflowOpts.retry_policy:type_name -> temporal.v1.RetryPolicyOpt
...
func init() { file_temporal_v1_temporal_types_v2_proto_init() }
func file_temporal_v1_temporal_types_v2_proto_init() {
	if File_temporal_v1_temporal_types_v2_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_temporal_v1_temporal_types_v2_proto_rawDesc), len(file_temporal_v1_temporal_types_v2_proto_rawDesc)),
			NumEnums:      10,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_temporal_v1_temporal_types_v2_proto_goTypes,
		DependencyIndexes: file_temporal_v1_temporal_types_v2_proto_depIdxs,
		EnumInfos:         file_temporal_v1_temporal_types_v2_proto_enumTypes,
		MessageInfos:      file_temporal_v1_temporal_types_v2_proto_msgTypes,
	}.Build()
	File_temporal_v1_temporal_types_v2_proto = out.File
	file_temporal_v1_temporal_types_v2_proto_goTypes = nil
	file_temporal_v1_temporal_types_v2_proto_depIdxs = nil
}
